#!/usr/bin/env python3
"""Compare frozen items 26-30 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_026_030_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_026_030_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_026_030_reconciliation.tsv"
FROZEN_LINES_SHA256 = "5f33bc5c2c88f2121595993e035d910ef2bfaedfef173e570933736c79604c6e"
FROZEN_CELLS_SHA256 = "94d439754d876f919d531e12fa6fc225180b83fd16ee9522b208a7817e999a6f"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 26 <= int(row["Item"]) <= 30]
