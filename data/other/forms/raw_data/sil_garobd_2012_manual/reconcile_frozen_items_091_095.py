#!/usr/bin/env python3
"""Compare frozen items 91-95 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_091_095_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_091_095_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_091_095_reconciliation.tsv"
FROZEN_LINES_SHA256 = "07891cfdd77c3b8dd795794aa960e4eb0e84c5bd4648ca52163b6738ef142612"
FROZEN_CELLS_SHA256 = "6df79246e57c34fca7c9b453f59d78afb26a54346306ab636011898b656b5c12"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 91 <= int(row["Item"]) <= 95]
