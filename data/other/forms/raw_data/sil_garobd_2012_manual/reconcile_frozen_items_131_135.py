#!/usr/bin/env python3
"""Compare frozen items 131-135 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_131_135_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_131_135_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_131_135_reconciliation.tsv"
FROZEN_LINES_SHA256 = "6e2fe3d52f10c0c6195d2b617a7a5946313f25a6ede88d97db941e97cddff739"
FROZEN_CELLS_SHA256 = "507a77bb4485fee980ec04fe3a5121256861385eb077bd44b6d2f37bc33c6a61"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 131 <= int(row["Item"]) <= 135]
