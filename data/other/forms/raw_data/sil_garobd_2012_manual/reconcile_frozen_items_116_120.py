#!/usr/bin/env python3
"""Compare frozen items 116-120 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_116_120_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_116_120_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_116_120_reconciliation.tsv"
FROZEN_LINES_SHA256 = "e7a6013d725adde0c21c754c04bf96da122aa49f7397268ed99e230336d7be05"
FROZEN_CELLS_SHA256 = "d1e0bacb0c9226efb4b875afff9294dcc393847119c217800c06a0feb2f77885"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 116 <= int(row["Item"]) <= 120]
