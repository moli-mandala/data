#!/usr/bin/env python3
"""Compare frozen items 121-125 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_121_125_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_121_125_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_121_125_reconciliation.tsv"
FROZEN_LINES_SHA256 = "daaa170a517e2ddd5d817dca376fbfa6a201d25a25f9294335c00083e58ed168"
FROZEN_CELLS_SHA256 = "7e51c2e1b55f96f22276938b19c545d6c7c89f048892bb310417ceb4b88051d7"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 121 <= int(row["Item"]) <= 125]
    assert len(legacy_rows) == 87
