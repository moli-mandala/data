#!/usr/bin/env python3
"""Compare frozen items 136-140 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_136_140_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_136_140_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_136_140_reconciliation.tsv"
FROZEN_LINES_SHA256 = "1d9ce5295e306441c43cc8a02a9bd6c50886d5310c1405fb10147268c89ff573"
FROZEN_CELLS_SHA256 = "f25022fa7b90ee7348048c578d251dbbee31d8ad307b5782be8ab301fb9c0a86"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 136 <= int(row["Item"]) <= 140]
