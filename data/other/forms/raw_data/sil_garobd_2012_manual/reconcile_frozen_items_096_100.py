#!/usr/bin/env python3
"""Compare frozen items 96-100 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_096_100_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_096_100_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_096_100_reconciliation.tsv"
FROZEN_LINES_SHA256 = "716e7158f56ba0923c070967786e2cabfe440dc25b5da4403062adf3b211acb1"
FROZEN_CELLS_SHA256 = "077c3601cdd952b5651223897e02e4111cf09294ecfb7f7221ccc173ff571c98"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 96 <= int(row["Item"]) <= 100]
    assert len(legacy_rows) == 90
