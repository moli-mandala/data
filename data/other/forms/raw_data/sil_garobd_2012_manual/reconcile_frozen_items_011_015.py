#!/usr/bin/env python3
"""Compare the frozen items 11-15 manual ledgers with the legacy audit.

The source prints both a blank and an attestation at item 12/site p, so this
reconciler expands the frozen line ledger rather than inferring line occurrences
from the conceptual-cell ledger. Both frozen hashes are required. Legacy values
remain audit-only and never feed back into either manual ledger.
"""
...
LINES = HERE / "manual_chunks" / "items_011_015_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_011_015_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_011_015_reconciliation.tsv"
FROZEN_LINES_SHA256 = "3eacb09dda9f6a108741150f35a725d38553f894882d5696c9e38d77fc98a751"
FROZEN_CELLS_SHA256 = "798064191bbfb60d8b2c8a9ef6deda8231126b07a708c4ca48785dc2f55e4e92"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [
        ...
        if 11 <= int(row["Item"]) <= 15
    ]
    assert len(legacy_rows) == 86
