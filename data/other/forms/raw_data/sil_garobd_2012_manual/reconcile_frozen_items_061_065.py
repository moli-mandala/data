#!/usr/bin/env python3
"""Compare frozen items 61-65 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_061_065_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_061_065_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_061_065_reconciliation.tsv"
FROZEN_LINES_SHA256 = "0cf581b3c0130c4f61b1107021210054a608c959267fd8972ec6946e59cdb432"
FROZEN_CELLS_SHA256 = "330257bfecd41354754894070ae3f49142b96c5f49d61445123895dc8f98f9a8"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 61 <= int(row["Item"]) <= 65]
