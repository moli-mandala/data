#!/usr/bin/env python3
"""Compare frozen items 106-110 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_106_110_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_106_110_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_106_110_reconciliation.tsv"
FROZEN_LINES_SHA256 = "d921478d8ced98de6af4aa0513931e2416e0702a365b05ae1fb4ab962ad05b13"
FROZEN_CELLS_SHA256 = "e4895ceae4dea93311cd6a3692da92f3f9a8eefee5061645081521848ad2de10"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 106 <= int(row["Item"]) <= 110]
