#!/usr/bin/env python3
"""Compare frozen items 31-35 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_031_035_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_031_035_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_031_035_reconciliation.tsv"
FROZEN_LINES_SHA256 = "8056dd177f979822ab3c1bdf7105d076ae75a0c02229e28fd2a3de87609ad514"
FROZEN_CELLS_SHA256 = "626147e6e2409c0a897b464e8b6d751df0013b8ddc0e78212f62648cef8a0efe"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 31 <= int(row["Item"]) <= 35]
