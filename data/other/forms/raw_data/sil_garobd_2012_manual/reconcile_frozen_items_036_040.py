#!/usr/bin/env python3
"""Compare frozen items 36-40 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_036_040_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_036_040_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_036_040_reconciliation.tsv"
FROZEN_LINES_SHA256 = "47bd07ff2f18e4b5d5980179bf7d5327897ff97e12a6f6e669a7a3a3ec499945"
FROZEN_CELLS_SHA256 = "b08479f603dda4896b116da64365cc39a1cd0ddf8794a072b34e7f5db4252b02"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 36 <= int(row["Item"]) <= 40]
