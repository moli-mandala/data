#!/usr/bin/env python3
"""Compare frozen items 21-25 manual ledgers with the audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_021_025_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_021_025_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_021_025_reconciliation.tsv"
FROZEN_LINES_SHA256 = "6942f1666d7938eafb28b435429357d999aa7a3f947fd00dba27b9692dd21c2b"
FROZEN_CELLS_SHA256 = "c9c3d36d60bb925658b5b36de8ccc190f6db92bd4f8c49e478d3b03d8645c1ae"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 21 <= int(row["Item"]) <= 25]
    assert len(legacy_rows) == 85
    ...
    for line in lines:
        for code in line["Bracket_Codes"]:
            ...
            out.append({
                ...
                "Source_Line_ID": line["Line_ID"], "Manual_Transcription": form,
