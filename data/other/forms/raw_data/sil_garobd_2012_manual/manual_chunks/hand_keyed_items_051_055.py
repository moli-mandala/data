#!/usr/bin/env python3
"""Freeze the OCR-blind Garo ESR 2012-007 ledgers for items 51-55.

Every response, group number, bracket code, and explicit blank below was
independently hand-keyed from physical PDF page 58 / printed page 51. The
...
LINES_OUTPUT = HERE / "items_051_055_lines.tsv"
CELLS_OUTPUT = HERE / "items_051_055_cells.tsv"
DECLARATION = (
...
PAGE_BY_ITEM = {
    **{item: ("58", "51", "left") for item in range(51, 54)},
    **{item: ("58", "51", "right") for item in range(54, 56)},
}

# One tuple per printed response line, in source order. Item 55's repeated site
# assignments across groups are deliberately preserved.
PRINTED_LINES = [
    (51, "coconut (ripe)", "0", "", "p", "no entry"),
    (51, "coconut (ripe)", "1", "narikɛl", "0deghilmo", ""),
    (51, "coconut (ripe)", "1", "narikol", "fn", ""),
    (51, "coconut (ripe)", "1", "narkol", "a", ""),
    (51, "coconut (ripe)", "2", "daba", "bc", ""),
    (51, "coconut (ripe)", "3", "soʔdaba", "jk", ""),

    (52, "banana", "1", "tʰai̯ʔirik", "ef", ""),
    (52, "banana", "1", "tʰiʔrɨk", "aho", ""),
    (52, "banana", "1", "tʰiʔrik", "dgin", ""),
    (52, "banana", "2", "lɛtʰai̯", "bc", ""),
    (52, "banana", "2", "rɛkʼtʰai̯", "lm", ""),
    (52, "banana", "3", "kai̯ʔ", "jk", ""),
    (52, "banana", "3", "kai̯tʼ", "p", ""),
    (52, "banana", "4", "kɔla", "0", ""),

    (53, "mango", "1", "tʰai̯ʔgatʃʰu", "ef", ""),
    (53, "mango", "1", "tʰɛʔgatʃʰu", "adghn", ""),
    (53, "mango", "1", "tʰiʔgatʃʰu", "o", ""),
    (53, "mango", "1", "tʰiʔgatʃu", "i", ""),
    (53, "mango", "2", "botʃor", "bc", ""),
    (53, "mango", "2", "botʃot", "lm", ""),
    (53, "mango", "3", "soʔpɛŋ", "jk", ""),
    (53, "mango", "3", "suʔpia̯ŋ", "p", ""),
    (53, "mango", "4", "am", "0", ""),

    (54, "flower", "0", "", "l", "no entry"),
    (54, "flower", "1", "bibal", "adefghio", ""),
    (54, "flower", "2", "par", "bc", ""),
    (54, "flower", "3", "sɨntɨ", "jp", ""),
    (54, "flower", "3", "sɨntɨu̯", "k", ""),
    (54, "flower", "4", "pʰul", "0mn", ""),

    (55, "seed", "0", "", "b", "no entry"),
    (55, "seed", "1", "bɨtʃʰri", "o", ""),
    (55, "seed", "1", "pɨtʃʰi", "a", ""),
    (55, "seed", "2", "bigoron", "f", ""),
    (55, "seed", "2", "bigron", "d", ""),
    ...
    (55, "seed", "5", "biʃun", "g", ""),
    (55, "seed", "6", "bɨtʃʰri", "o", ""),
    (55, "seed", "6", "bɨtʃʰɨri", "i", ""),
    (55, "seed", "7", "tʃɨlɨi̯", "jk", ""),
    (55, "seed", "7", "tʃara", "m", ""),
    (55, "seed", "7", "tʃari", "l", ""),
    (55, "seed", "8", "bidʒ", "0c", ""),
    (55, "seed", "9", "kʰut lia̯ŋ", "p", ""),
    (55, "seed", "A", "goron", "efn", ""),
    (55, "seed", "A", "gron", "h", ""),
]
...
def cell_rows(lines: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
    ...
    expected = {(item, code) for item in range(51, 56) for code in SITE_CODES}
...
def main() -> None:
    ...
    assert sum(len(row["Manual_Transcription"].split(" | ")) for row in cells if row["Manual_Transcription"]) == 90
