#!/usr/bin/env python3
"""Freeze the OCR-blind Garo ESR 2012-007 ledgers for items 6-10.

Every response, similarity-group number, bracket code, and explicit blank below
was independently hand-keyed from physical PDF pages 52-53 / printed pages 45-46.
...
LINES_OUTPUT = HERE / "items_006_010_lines.tsv"
CELLS_OUTPUT = HERE / "items_006_010_cells.tsv"
DECLARATION = (
...
# Parenthesized strings and repeated response lines are deliberately preserved.
PRINTED_LINES = [
    (6, "rain", "1", "mɨkʼkʰa", "adghino", ""),
    (6, "rain", "1", "mukʼkʰa", "ef", ""),
    (6, "rain", "2", "raŋ", "bclm", ""),
    (6, "rain", "3", "slap", "p", ""),
    (6, "rain", "3", "slapʼ", "jk", ""),
    ...
    (7, "rainbow", "0", "", "flop", "no entry"),
    (7, "rainbow", "1", "ʃundari", "aei", ""),
    (7, "rainbow", "2", "ʃim pʰleo̯", "jk", ""),
    (7, "rainbow", "3", "tʃɛŋroŋ", "m", ""),
    (7, "rainbow", "4", "ramdʰanu", "h", ""),
    (7, "rainbow", "4", "ramdʰonukʼ", "bcn", ""),
    (7, "rainbow", "4", "rɔŋdʰɔnu", "0dgn", ""),

    (8, "wind", "1", "balua̯", "adefghilmno", ""),
    (8, "wind", "2", "lampar", "bc", ""),
    (8, "wind", "3", "lɨŋ ɪr", "jk", ""),
    (8, "wind", "3", "lɨŋ ir", "p", ""),
    (8, "wind", "4", "bataʃ", "0", ""),

    (9, "lightning", "0", "", "fn", "no entry"),
    (9, "lightning", "1", "(mɨkʼkʰa) hɛlapuŋa", "a", ""),
    (9, "lightning", "2", "raŋtʃi lou̯ni", "c", ""),
    (9, "lightning", "2", "raŋtʃim lau̯ni", "b", ""),
    (9, "lightning", "3", "(mɨkʼkʰa) lɛba", "i", ""),
    (9, "lightning", "4", "(mɨkʼkʰa) dʒɨʔlɨka", "h", ""),
    (9, "lightning", "5", "pɨrtʰatʼ", "jk", ""),
    (9, "lightning", "6", "raŋ dilɪppa", "lm", ""),
    (9, "lightning", "7", "bɪddut tʃomkano", "0", ""),
    (9, "lightning", "8", "kɨmbliŋ", "p", ""),
    (9, "lightning", "9", "(mɨkʼkʰa) lɛŋʔlapa", "dego", ""),

    (10, "thunder", "0", "", "bop", "no entry"),
    (10, "thunder", "1", "(mɨkʼkʰa) kʰɨm pʰlɛʔtoŋa", "a", ""),
    (10, "thunder", "1", "kʰum prɛʔta", "ef", ""),
    (10, "thunder", "2", "(mɨkʼkʰa) kʰɨm pʰrɛda", "i", ""),
    (10, "thunder", "2", "kʰɨm pʰrɛta", "gn", ""),
    (10, "thunder", "2", "kʰum prɛʔta", "ef", ""),
    (10, "thunder", "3", "(mɨkʼkʰa) kʰɨma", "dh", ""),
    (10, "thunder", "4", "raŋpatni", "c", ""),
    (10, "thunder", "5", "pram bɨbri", "j", ""),
    (10, "thunder", "5", "pram bri", "k", ""),
    (10, "thunder", "6", "raŋ kɨrɨŋwa", "lm", ""),
    (10, "thunder", "7", "mɛɡʰ ɡɔdʒoŋ", "0", ""),
]
...
def cell_rows(lines: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
    ...
    expected = {(item, code) for item in range(6, 11) for code in SITE_CODES}
...
def main() -> None:
    ...
    assert len(lines) == 41
    assert len(cells) == 85
    assert sum(row["Review_Status"] == "attested" for row in cells) == 76
    assert sum(row["Review_Status"] == "source_blank" for row in cells) == 9
    assert sum(len(row["Manual_Transcription"].split(" | ")) for row in cells if row["Manual_Transcription"]) == 79
