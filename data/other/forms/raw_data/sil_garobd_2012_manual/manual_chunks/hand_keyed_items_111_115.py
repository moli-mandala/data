#!/usr/bin/env python3
"""Freeze the OCR-blind Garo ESR 2012-007 ledgers for items 111-115.

Every response, group number, bracket code, repetition, and explicit blank below
was independently hand-keyed from physical PDF pages 66-67 / printed pages
59-60. The 300-dpi pages were primary and small IPA marks were checked in
...
LINES_OUTPUT = HERE / "items_111_115_lines.tsv"
CELLS_OUTPUT = HERE / "items_111_115_cells.tsv"
DECLARATION = (
...
PAGE_BY_ITEM = {
    111: ("66", "59", "right"),
    **{item: ("67", "60", "left") for item in range(112, 116)},
}

# One tuple per printed response line, in source order.
PRINTED_LINES = [
    (111, "elbow", "0", "", "p", "no entry"),
    (111, "elbow", "1", "d͜ʒakʼʃkʰu", "o", ""),
    (111, "elbow", "1", "d͜ʒakʼskʰu", "hi", ""),
    (111, "elbow", "1", "tʃakʼskʰu", "a", ""),
    (111, "elbow", "2", "d͜ʒakʼgila", "f", ""),
    (111, "elbow", "2", "tʃa gilai̯", "c", ""),
    (111, "elbow", "2", "tʃakʼgilai̯", "b", ""),
    (111, "elbow", "3", "d͜ʒakʼtʃukʼ", "deg", ""),
    (111, "elbow", "3", "tʃakʼtʃukʼ", "l", ""),
    (111, "elbow", "4", "toŋkai̯", "jk", ""),
    (111, "elbow", "5", "tʃakʼwɛŋ", "m", ""),
    (111, "elbow", "6", "d͜ʒakʼkuni", "n", ""),
    (111, "elbow", "7", "konui", "0", ""),

    (112, "hand", "1", "d͜ʒakʼ", "adefghino", ""),
    (112, "hand", "1", "tʃakʼ", "lm", ""),
    (112, "hand", "2", "hat", "0", ""),
    (112, "hand", "3", "t͜ʒakʼaprakʼ", "bc", ""),
    (112, "hand", "4", "kʰtɨi̯", "jk", ""),
    (112, "hand", "4", "kʰtei̯", "p", ""),

    (113, "palm", "1", "d͜ʒakʼpʰa", "adeghio", ""),
    (113, "palm", "1", "d͜ʒapʰa", "j", ""),
    (113, "palm", "1", "tʃakʼpʰa", "lm", ""),
    (113, "palm", "2", "d͜ʒakʼpʰa", "adeghio", ""),
    (113, "palm", "2", "d͜ʒakʼpʰatʰai̯", "f", ""),
    (113, "palm", "3", "d͜ʒakʼtɔla", "n", ""),
    (113, "palm", "3", "t͜ʒakʼtala", "bc", ""),
    (113, "palm", "4", "kʰtɨi̯", "k", ""),
    (113, "palm", "5", "hatɛr tɔla", "0", ""),
    (113, "palm", "6", "sla kʰtɪ", "p", ""),

    (114, "finger", "1", "d͜ʒakʼʃi", "adefghino", ""),
    (114, "finger", "1", "tʃakʼʃi", "lm", ""),
    (114, "finger", "1", "tʃaʃi", "bc", ""),
    (114, "finger", "2", "lutɨi̯", "jk", ""),
    (114, "finger", "2", "lutei̯", "p", ""),
    (114, "finger", "3", "aŋgur", "0", ""),

    (115, "fingernail", "1", "d͜ʒakʼʃukʰul", "ef", ""),
    (115, "fingernail", "1", "d͜ʒakʼsɨkɨl", "hi", ""),
    (115, "fingernail", "1", "d͜ʒakʼsɨkʰɨl", "ago", ""),
    (115, "fingernail", "1", "d͜ʒakʼsɨkul", "d", ""),
    (115, "fingernail", "1", "d͜ʒakʼsukul", "n", ""),
    (115, "fingernail", "1", "tʃakʼʃikʰor", "m", ""),
    (115, "fingernail", "1", "tʃakʼʃikor", "bcl", ""),
    (115, "fingernail", "2", "tursim", "jkp", ""),
    (115, "fingernail", "3", "nok", "0", ""),
]
...
def cell_rows(lines: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
    ...
    expected = {(item, code) for item in range(111, 116) for code in SITE_CODES}
