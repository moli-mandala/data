#!/usr/bin/env python3
"""Freeze the OCR-blind Garo ESR 2012-007 ledgers for items 126-130.

Every response, group number, bracket code, repetition, and explicit blank below
was independently hand-keyed from physical PDF page 69 / printed page 62. The
...
LINES_OUTPUT = HERE / "items_126_130_lines.tsv"
CELLS_OUTPUT = HERE / "items_126_130_cells.tsv"
DECLARATION = (
...
PAGE_BY_ITEM = {
    **{item: ("69", "62", "left") for item in range(126, 129)},
    **{item: ("69", "62", "right") for item in range(129, 131)},
}

# One tuple per printed response line, in source order.
PRINTED_LINES = [
    (126, "body", "0", "", "h", "no entry"),
    (126, "body", "1", "bimaŋ", "adio", ""),
    (126, "body", "2", "kan", "bc", ""),
    (126, "body", "3", "bɛʔɛn", "defg", ""),
    (126, "body", "4", "pʰatʼ", "jk", ""),
    (126, "body", "5", "randai̯", "lm", ""),
    (126, "body", "6", "han", "n", ""),
    (126, "body", "7", "ga", "0", ""),
    (126, "body", "8", "mɨm pʰat brɨ", "p", ""),

    (127, "person", "1", "mandai̯", "ef", ""),
    (127, "person", "1", "mandei̯", "h", ""),
    (127, "person", "1", "mandi", "adgimno", ""),
    (127, "person", "2", "morotʼ", "bcl", ""),
    (127, "person", "3", "brɨu̯", "k", ""),
    (127, "person", "3", "bru", "j", ""),
    (127, "person", "3", "brɨ", "p", ""),
    (127, "person", "4", "lok", "0", ""),

    (128, "man", "1", "mɛʔaʃa", "dhno", ""),
    (128, "man", "1", "mɛʔasa", "g", ""),
    (128, "man", "1", "mɛʔɛʃa", "ai", ""),
    (128, "man", "1", "miʔaʃa", "ef", ""),
    (128, "man", "2", "purʃi", "c", ""),
    (128, "man", "2", "puʃi", "b", ""),
    (128, "man", "3", "kʰoŋkoraŋ", "jkp", ""),
    (128, "man", "4", "bipʰa", "lm", ""),
    (128, "man", "5", "puruʃ", "0", ""),

    (129, "woman", "1", "mitʃɨkʼʃa", "adfghi", ""),
    (129, "woman", "1", "mitʃikʼʃa", "en", ""),
    (129, "woman", "2", "mitʃʰik", "o", ""),
    (129, "woman", "3", "tiri", "bc", ""),
    (129, "woman", "4", "rao̯kmao̯", "p", ""),
    (129, "woman", "4", "rokʼmao̯", "jk", ""),
    (129, "woman", "5", "gɨwuɨ̯", "lm", ""),
    (129, "woman", "6", "mohɨla", "0", ""),

    (130, "father", "1", "abba", "a", ""),
    (130, "father", "1", "apʼpʰa", "eio", ""),
    (130, "father", "2", "awa", "bcm", ""),
    (130, "father", "3", "pa", "jkp", ""),
    (130, "father", "4", "baba", "0dfghl", ""),
    (130, "father", "4", "babu", "n", ""),
]
...
def cell_rows(lines: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
    ...
    expected = {(item, code) for item in range(126, 131) for code in SITE_CODES}
