#!/usr/bin/env python3
"""Freeze the OCR-blind Garo ESR 2012-007 ledgers for items 41-45.

Every response, group number, bracket code, and explicit blank below was
independently hand-keyed from physical PDF page 57 / printed page 50. The
...
LINES_OUTPUT = HERE / "items_041_045_lines.tsv"
CELLS_OUTPUT = HERE / "items_041_045_cells.tsv"
DECLARATION = (
...
PAGE_BY_ITEM = {item: ("57", "50", "left") for item in range(41, 46)}

# One tuple per printed response line, in source order. The repeated item 45/site
# b assignment is deliberately preserved.
PRINTED_LINES = [
    (41, "eggplant", "0", "", "p", "no entry"),
    (41, "eggplant", "1", "bai̯gon", "defghn", ""),
    (41, "eggplant", "1", "barɨŋ", "aio", ""),
    (41, "eggplant", "1", "bɛgun", "0", ""),
    (41, "eggplant", "2", "bantao̯", "bc", ""),
    (41, "eggplant", "2", "mantao̯", "jklm", ""),

    (42, "peanut", "0", "", "p", "no entry"),
    (42, "peanut", "1", "kotloŋ", "e", ""),
    (42, "peanut", "2", "badam", "0abcdfghijklmno", ""),

    (43, "tree", "1", "pʰaŋ", "ano", ""),
    (43, "tree", "2", "pan", "bcdefghi", ""),
    (43, "tree", "3", "dɛŋ", "jk", ""),
    (43, "tree", "3", "ə dia̯ŋ", "p", ""),
    (43, "tree", "4", "panpʰaŋ", "lm", ""),
    (43, "tree", "5", "gatʃʰ", "0", ""),

    (44, "branch", "1", "ɖal", "0g", ""),
    (44, "branch", "1", "dal", "ao", ""),
    (44, "branch", "1", "dala", "bcdehlmn", ""),
    (44, "branch", "2", "tʃɛkʃi", "f", ""),
    (44, "branch", "3", "boldal", "i", ""),
    (44, "branch", "4", "rɨka", "jkp", ""),

    (45, "leaf", "1", "bidʒakʼ", "adefghino", ""),
    (45, "leaf", "2", "lai̯tʃak", "b", ""),
    (45, "leaf", "2", "lɛsak", "c", ""),
    (45, "leaf", "3", "sla", "jkp", ""),
    (45, "leaf", "4", "lai̯tʃak", "b", ""),
    (45, "leaf", "4", "pantʃak", "lm", ""),
    (45, "leaf", "5", "pata", "0", ""),
]
...
def cell_rows(lines: list[dict[str, str]] | None = None) -> list[dict[str, str]]:
    ...
    expected = {(item, code) for item in range(41, 46) for code in SITE_CODES}
...
def main() -> None:
    ...
    assert sum(len(row["Manual_Transcription"].split(" | ")) for row in cells if row["Manual_Transcription"]) == 84
