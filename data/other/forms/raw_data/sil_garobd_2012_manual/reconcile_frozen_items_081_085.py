#!/usr/bin/env python3
"""Compare frozen items 81-85 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_081_085_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_081_085_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_081_085_reconciliation.tsv"
FROZEN_LINES_SHA256 = "5d14d168343fac96738a569aecfb6fdbd8fd7e62de550294a7a416417e351b02"
FROZEN_CELLS_SHA256 = "806497e9feb387435869521ae77e7e638a091dcd0494c4ebfad0bd753bae7158"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 81 <= int(row["Item"]) <= 85]
