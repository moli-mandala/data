#!/usr/bin/env python3
"""Compare frozen items 86-90 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_086_090_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_086_090_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_086_090_reconciliation.tsv"
FROZEN_LINES_SHA256 = "6c8102eca4bc1fa0562f10d9ebea6db9e48faa4671ee0c87d453287922951841"
FROZEN_CELLS_SHA256 = "c0b9e9c712d8accfc0ebc4fd927ce0c6a0ab1743464199512784b32d0cf3b1de"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 86 <= int(row["Item"]) <= 90]
