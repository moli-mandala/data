#!/usr/bin/env python3
"""Compare frozen items 151-155 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_151_155_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_151_155_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_151_155_reconciliation.tsv"
FROZEN_LINES_SHA256 = "4a27e46d006b8ed41aaf9b0eaf91b0512d2c26509e1a41be64a8a59977f0ce8e"
FROZEN_CELLS_SHA256 = "30a0027ed820e86bd60012401bbbd15ea907436efe0c5faec83cee656f16dbf8"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 151 <= int(row["Item"]) <= 155]
    assert len(legacy_rows) == 73
    ...
    for line in lines:
        # The source and legacy audit each represent item 152's whole-item
