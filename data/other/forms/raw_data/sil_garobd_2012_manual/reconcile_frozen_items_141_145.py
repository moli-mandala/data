#!/usr/bin/env python3
"""Compare frozen items 141-145 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_141_145_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_141_145_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_141_145_reconciliation.tsv"
FROZEN_LINES_SHA256 = "4c87f15329e87138a41c399c681b1208a65c605413473872daea9baa9b2d1e34"
FROZEN_CELLS_SHA256 = "9c399b83d4fc149b05ef38da2044869734ddcbc4c4b939e7b623feb56c76bb6b"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 141 <= int(row["Item"]) <= 145]
