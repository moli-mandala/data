#!/usr/bin/env python3
"""Compare frozen items 41-45 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_041_045_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_041_045_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_041_045_reconciliation.tsv"
FROZEN_LINES_SHA256 = "eee5522568ef0a005750f09f7889f03a65e01cce74ac8921edf0924691fc23e3"
FROZEN_CELLS_SHA256 = "9f0aa56406f35534200d20884d97f634abd12479af108bace87d9940dc431e88"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 41 <= int(row["Item"]) <= 45]
