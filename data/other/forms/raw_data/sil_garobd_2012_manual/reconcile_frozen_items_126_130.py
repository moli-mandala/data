#!/usr/bin/env python3
"""Compare frozen items 126-130 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_126_130_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_126_130_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_126_130_reconciliation.tsv"
FROZEN_LINES_SHA256 = "b0553472a7d792971c297157e4f2dfec3b9d0552b6ef16f9eb14ec30813da7ba"
FROZEN_CELLS_SHA256 = "752d486fa187b7e572d96298753198ceda5a546275b3fe13dbf8cf785de0045d"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 126 <= int(row["Item"]) <= 130]
