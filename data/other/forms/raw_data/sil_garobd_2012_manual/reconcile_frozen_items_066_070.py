#!/usr/bin/env python3
"""Compare frozen items 66-70 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_066_070_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_066_070_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_066_070_reconciliation.tsv"
FROZEN_LINES_SHA256 = "31fa9ef75b740383d8b142cabb4599340036523c0db41679e856081b3de86fbf"
FROZEN_CELLS_SHA256 = "d60d6f21861bbd495682396fddeb2c3fb43c1e7fc7ccf6202ed540760f18df16"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 66 <= int(row["Item"]) <= 70]
