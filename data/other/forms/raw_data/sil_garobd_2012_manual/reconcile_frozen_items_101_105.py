#!/usr/bin/env python3
"""Compare frozen items 101-105 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_101_105_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_101_105_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_101_105_reconciliation.tsv"
FROZEN_LINES_SHA256 = "f2d5815abb6464c56c8f233ba5065639d44658fee35125d82ada2b325ddfc8f1"
FROZEN_CELLS_SHA256 = "21674f63024b05a1aaf172b1aab290da0ac89db2f68de7444b38fbbf87cac330"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 101 <= int(row["Item"]) <= 105]
    assert len(legacy_rows) == 91
