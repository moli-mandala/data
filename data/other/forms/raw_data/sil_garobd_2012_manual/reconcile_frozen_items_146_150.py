#!/usr/bin/env python3
"""Compare frozen items 146-150 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_146_150_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_146_150_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_146_150_reconciliation.tsv"
FROZEN_LINES_SHA256 = "cf1d8cc378bb0bda8e43c0b1423a790a1a5be72139641a764d8174ecebd21879"
FROZEN_CELLS_SHA256 = "1c005924a106851f44ef745f9cfedaab0ce978c6ccf8c51f5a5137fb17d1266f"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 146 <= int(row["Item"]) <= 150]
    assert len(legacy_rows) == 89
