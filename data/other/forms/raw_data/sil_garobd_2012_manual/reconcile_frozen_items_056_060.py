#!/usr/bin/env python3
"""Compare frozen items 56-60 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_056_060_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_056_060_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_056_060_reconciliation.tsv"
FROZEN_LINES_SHA256 = "fdef82b2af8e98483258f1969f6d9326e35ca8b8055de88f06a6eac0a646d3c2"
FROZEN_CELLS_SHA256 = "52602badeea291130e1ca8fea4529429343b70d9499932aa6ddeb45005ca3780"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 56 <= int(row["Item"]) <= 60]
    assert len(legacy_rows) == 109
