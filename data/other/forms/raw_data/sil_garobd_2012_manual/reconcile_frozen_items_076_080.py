#!/usr/bin/env python3
"""Compare frozen items 76-80 manual ledgers with audit-only legacy data."""
...
LINES = HERE / "manual_chunks" / "items_076_080_lines.tsv"
CELLS = HERE / "manual_chunks" / "items_076_080_cells.tsv"
LEGACY_AUDIT = HERE.parent / "20260826-sil-garobd-audit.csv"
OUTPUT = HERE / "manual_chunks" / "items_076_080_reconciliation.tsv"
FROZEN_LINES_SHA256 = "c3e59a31ab8c000251143236e05b87f69424b186c5397a9e725d261a1e59e4e6"
FROZEN_CELLS_SHA256 = "175cd971fc73057b2ae3ef8d2744ade4669a8a8a9925f265c4dec748339e3f37"
FIELDS = [
...
def reconciliation_rows() -> list[dict[str, str]]:
    ...
    legacy_rows = [row for row in read_csv(LEGACY_AUDIT) if 76 <= int(row["Item"]) <= 80]
