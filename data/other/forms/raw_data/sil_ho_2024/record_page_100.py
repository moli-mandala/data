#!/usr/bin/env python3
"""Record manual source-image transcription for PDF page 100 (items 85-87)."""
...
PAGE={
85:("fat",["1 iṯil"]*13+[None]+["1 iṯil"]*8+[None,"1 iṯil","1 iṯil","1 iṯil","2 tʃarbi"]),
86:("fish",["1 haku, 2 hai","2 hai","2 hʌi","2 hai","1 hʌku","1 hʌku","1 hʌku, 2 hai","1 hʌku, 2 hʌi","1 hʌku","1 haku","2 hai","1 haku","1 haku",None,"2 hai","2 hʌi","2 hai","2 hai","2 hei","2 hai","2 hʌi","2 hai",None,"2 hai","1 haku","1 hʌku","3 ma·tʃo"]),
87:("chicken",["1 sim"]*11+[None,"1 sim","1 sim"]+["1 sim"]*12+["2 kukuda"]),
}
def main():
 ...
 for row in rows:
  ...
  if int(row["PDF_Page"])!=100 or key not in expected: continue
  i,s=key; gloss,forms=PAGE[i]; form=forms[SITES.index(s)]; special=form is not None and any(c in form for c in "̱ʌ·")
 ...
 print("recorded 81 manually reviewed cells for PDF page 100 (items 85-87)")
