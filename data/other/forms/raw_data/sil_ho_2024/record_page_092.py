#!/usr/bin/env python3
"""Record manual source-image transcription for PDF page 92 (items 61-63)."""
...
PAGE={
61:("tree",["1 ɖaru"]*13+[None,"1 ɖaru","1 ɖaru","1 ɖaru","1 ɖaru","1 ɖari","1 ɖaru","1 ɖʌru","1 ɖaru",None,"1 ɖaru","1 ɖare","1 ɖare","2 getʃʰe"]),
62:("leaf",["1 sakam","1 sʌkʌm","1 sʌkʌm","1 sʌkʌm","1 sʌkʌm","1 sukam","1 sʌkʌm","1 sʌkʌm, 2 pʌṯa?a","1 sʌkʌm","1 sʌkʌm","2 pʌṯa","1 sakam","1 sakam",None,"1 sakam","1 sʌkʌm","1 sekʌm","1 sakʌm","1 sikʌm","1 sakam","1 sikam","1 sikam",None,"1 sakam","1 sakam","1 sakam","2 potro"]),
63:("root",["1 reḏ","1 red?","1 red?","1 re?n","1 ren?","1 re?n","1 red?","1 red?","1 ret?","1 re?t","1 red?","1 reḏ","1 re?n",None,"1 re?t","1 redm?","1 ret?","1 red?","1 red?","1 re?n","1 rehe?t","1 re?t",None,"2 dʒer","1 rehet?","1 rehet?","2 tʃero"]),
}
def main():
 ...
 for row in rows:
  ...
  if int(row["PDF_Page"])!=92 or key not in expected: continue
  i,s=key; gloss,forms=PAGE[i]; form=forms[SITES.index(s)]; special=form is not None and any(c in form for c in "̱ʌɖʰ")
 ...
 print("recorded 81 manually reviewed cells for PDF page 92 (items 61-63)")
