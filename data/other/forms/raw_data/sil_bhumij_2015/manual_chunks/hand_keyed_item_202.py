#!/usr/bin/env python3
"""Write visually checked Bhumij Appendix B3 cells for item 202."""
...
OUT = HERE / "items_202_202_hand_keyed.tsv"
DECLARATION = "hand-keyed-from-rendered-source; OCR-not-copied"
METHOD = (
    "manual visual inspection of the 400-dpi rendered PDF page with alveolar "
    "versus velar nasals, nasalization, and separately numbered responses "
    "rechecked in 800-dpi source-image crops; OCR/PDF text neither supplied nor "
...
def build_rows():
    ...
    for code, (language, site, target) in SITES.items():
        ...
        row = {
            "Item": "202", "Gloss": "I (1st sg)", "Site_Code": code,
