#!/usr/bin/env python3
"""Write the OCR-blind Bonda 2022-005 ledger for items 51-55.
...
OUTPUT = HERE / "items_051_055_hand_keyed.tsv"
...
PAGE_DECISIONS = [
    ...
    (53, "path", (
        ...
        ("kʊɾʊŋ", "2", ""), ("gʌli", "5", ""),
        ("kuɾoŋ", "2", ""), ("bɛt̪", "4", ""),
        ("rast̪ɾa | bat̪o", "3|4", "two responses printed on separate lines for ODI"),
    )),
    (54, "sand", (
        ("bali", "1", ""), ("bʌli", "1", ""),
        ("bali", "1", ""), ("balɪ", "1", ""),
        ("t̪ʊbu", "5", ""), ("balɪ", "1", ""),
        ("bəli | bɪt̪ɪl", "1|3", "two responses printed on separate lines for the same two-line GUT label"),
        ("bəli", "1", ""), ("lʌkɪ", "2", ""),
        ("balɪ", "1", ""), ("baɭi", "1", ""),
    )),
    (55, "fire", (
...
def source_pages(item: int, site_code: str) -> tuple[str, str]:
    if item <= 53 or (item == 54 and site_code in {"POD", "BON", "DUM", "KAD"}):
        return "22", "17"
    return "23", "18"
