#!/usr/bin/env python3
"""Write the OCR-blind Bonda 2022-005 ledger for items 146-150.
...
OUTPUT = HERE / "items_146_150_hand_keyed.tsv"
...
PAGE_DECISIONS = [
    ...
    (147, "below", (
        ("aluŋ", "1", ""), ("aluŋ", "1", ""),
        ("ʌluŋ", "1", ""),
        ("ʌluŋ | dʒokt̪o", "1|2", "responses printed on separate group-1 and group-2 lines for KAD"),
        ("dʒokt̪o", "2", ""), ("ʌluŋ", "1", ""),
        ("dʒot̪:o", "2", ""), ("bʌlo", "5", ""),
        ("lobo", "3", ""), ("t̪ɔle", "4", ""),
        ("t̪əɭə", "4", ""),
    ...
    (150, "red", (
        ...
        ("roŋ", "2", ""), ("tʃi", "1", ""),
        ("rɔŋ", "2", ""), ("rɔŋ", "2", ""),
        ("roŋgo | nali", "2|3", "responses printed on separate group-2 and group-3 lines for ODI"),
    )),
]
...
def make_row(item: int, gloss: str, site, form: str, groups: str,
    ...
    row = {
        ...
        "Site_Name": site_name, "PDF_Page": "37", "Printed_Page": "32",
