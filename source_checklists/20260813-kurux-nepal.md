# Source ingestion checklist — 20260813-kurux-nepal

- Installed input: `data/other/forms/20260813-kurux-nepal.csv`
...
- Installed rows: 1336
- Compiled rows carrying this unit's citation keys: 1319
- Source keys: shackelford-swenson-chaudhary-maggard2022kurux

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: shackelford-swenson-chaudhary-maggard2022kurux; 1336 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/kurux_nepal.py
- [x] 3. Plan the installed files and identifiers — 1336 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1336}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/kurux-nepal.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kurux_nepal.py, tests/test_source_checklists.py
...
- Counts: 1336 installed records; 1319 compiled citation attestations.
...
- Transcription: `conversion/kurux-nepal.txt`.
