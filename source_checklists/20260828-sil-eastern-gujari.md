# Source ingestion checklist — 20260828-sil-eastern-gujari

- Installed input: `data/other/forms/20260828-sil-eastern-gujari.csv`
...
- Installed rows: 1753
- Compiled rows carrying this unit's citation keys: 583
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: hugoniot-polster-ahmad-rajan2023easterngujari
...
- [x] 3. Plan the installed files and identifiers — 1753 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1753}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-eastern-gujari.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/sil_eastern_gujari_2023/reviewed_transcription.tsv, data/other/forms/raw_data/20260828-sil-eastern-gujari-audit.csv, data/other/forms/raw_data/20260828-sil-eastern-gujari-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_eastern_gujari_2023.py, tests/test_source_checklists.py
...
- Counts: 1753 installed records; 583 compiled citation attestations.
- Exclusions: twenty-five blank Indian target cells, eight blank non-target cells, 1,254 attested Pakistan Gujari cells republished from SSNP volume 3, 208 attested Urdu control cells, and one exact repeated Jammu target alternative are audit-only; 1,753 new Indian forms install.
- Unresolved cases: no cell is ambiguous, clipped, illegible, or unresolved. The six Pakistan lists map explicitly to existing primary-source SSNP dialects and never overwrite them.
- Transcription: `conversion/sil-eastern-gujari.txt`; all 3,150 cells across thirty-five lexical pages were manually compared with 180-dpi renders. The Unicode text layer was only a scaffold and OCR was not used.
...
- Representative app entries: Udhampur body `dʒhɑn`, Haldwani body alternative `dʒɪsʌm`, and Nalagarh item 176 alternative `fʌɷək`.
