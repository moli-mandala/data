# Source ingestion checklist — 20260813-dewas-rai

- Installed input: `data/other/forms/20260813-dewas-rai.csv`
...
- Installed rows: 1922
- Compiled rows carrying this unit's citation keys: 1922
- Source keys: shackelford2019dewas-rai

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: shackelford2019dewas-rai; 1922 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/dewas_rai_2019.py
- [x] 3. Plan the installed files and identifiers — 1922 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 6 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1922}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/dewas-rai.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_dewas_rai_2019.py, tests/test_source_checklists.py
...
- Counts: 1922 installed records; 1922 compiled citation attestations.
...
- Transcription: `conversion/dewas-rai.txt`.
