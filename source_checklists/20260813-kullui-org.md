# Source ingestion checklist — 20260813-kullui-org

- Installed input: `data/other/forms/20260813-kullui-org.csv`
...
- Installed rows: 2003
- Compiled rows carrying this unit's citation keys: 2003
- Source keys: kullui-org

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kullui-org; 2003 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/kullui_org.py
- [x] 3. Plan the installed files and identifiers — 2003 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2003}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/kullui.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kullui_org.py, tests/test_source_checklists.py
...
- Counts: 2003 installed records; 2003 compiled citation attestations.
...
- Transcription: `conversion/kullui.txt`.
