# Source ingestion checklist — 20260828-sil-bishnupriya

- Installed input: `data/other/forms/20260828-sil-bishnupriya.csv`
...
- Installed rows: 1801
- Compiled rows carrying this unit's citation keys: 1801
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: kim-kim2008bishnupriya

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kim-kim2008bishnupriya; 1801 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/20260828-sil-bishnupriya.csv
- [x] 3. Plan the installed files and identifiers — 1801 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1801}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-bishnupriya.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-sil-bishnupriya-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_bishnupriya_2008.py, tests/test_source_checklists.py
...
- Counts: 1801 installed records; 1801 compiled citation attestations.
...
- Transcription: `conversion/sil-bishnupriya.txt`.
