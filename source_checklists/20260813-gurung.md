# Source ingestion checklist — 20260813-gurung

- Installed input: `data/other/forms/20260813-gurung.csv`
...
- Installed rows: 1574
- Compiled rows carrying this unit's citation keys: 1379
- Source keys: swenson2019gurung

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: swenson2019gurung; 1574 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/gurung.py
- [x] 3. Plan the installed files and identifiers — 1574 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 6 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1574}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/gurung.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_gurung.py, tests/test_source_checklists.py
...
- Counts: 1574 installed records; 1379 compiled citation attestations.
...
- Transcription: `conversion/gurung.txt`.
