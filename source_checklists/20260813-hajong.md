# Source ingestion checklist — 20260813-hajong

- Installed input: `data/other/forms/20260813-hajong.csv`
...
- Installed rows: 3311
- Compiled rows carrying this unit's citation keys: 3311
- Source keys: kim-ahmad-kim-sangma2011hajong

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kim-ahmad-kim-sangma2011hajong; 3311 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/hajong_2011.py
- [x] 3. Plan the installed files and identifiers — 3311 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 10 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 3311}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/hajong-survey.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_hajong_2011.py, tests/test_source_checklists.py
...
- Counts: 3311 installed records; 3311 compiled citation attestations.
...
- Transcription: `conversion/hajong-survey.txt`.
