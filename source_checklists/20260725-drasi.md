# Source ingestion checklist — 20260725-drasi

- Installed input: `data/other/forms/20260725-drasi.csv`
...
- Installed rows: 3551
- Compiled rows carrying this unit's citation keys: 3021
- Source keys: rajapurohit2012

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: rajapurohit2012; 3551 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/drasi.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 3551}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/drasi.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_drasi.py, tests/test_source_checklists.py
...
- Counts: 3551 installed records; 3021 compiled citation attestations.
...
- Transcription: `conversion/drasi.txt`.
