# Source ingestion checklist — 20260825-herin-domari-aleppo

- Installed input: `data/other/forms/20260825-herin-domari-aleppo.csv`
...
- Installed rows: 1074
- Compiled rows carrying this unit's citation keys: 1003
- Input rows with checked grammatical evidence: 696
- Compiled rows with canonical grammatical tags: 661
- Source keys: herin2012domari

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: herin2012domari; 1074 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/herin_domari_aleppo_2012.py
- [x] 3. Plan the installed files and identifiers — 1074 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1074}; blank forms 0
- [x] 6. Parse structured linguistic information — 696 input rows carry checked grammatical evidence; 661 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/domari-aleppo.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-herin-domari-aleppo-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_herin_domari_aleppo.py, tests/test_source_checklists.py
...
- Counts: 1074 installed records; 1003 compiled citation attestations.
...
- Transcription: `conversion/domari-aleppo.txt`.
