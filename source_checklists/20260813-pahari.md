# Source ingestion checklist — 20260813-pahari

- Installed input: `data/other/forms/20260813-pahari.csv`
...
- Installed rows: 1452
- Compiled rows carrying this unit's citation keys: 1452
- Source keys: smith2022pahari

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: smith2022pahari; 1452 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/pahari.py
- [x] 3. Plan the installed files and identifiers — 1452 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1452}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/pahari.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_pahari.py, tests/test_source_checklists.py
...
- Counts: 1452 installed records; 1452 compiled citation attestations.
...
- Transcription: `conversion/pahari.txt`.
