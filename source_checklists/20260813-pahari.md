...
- Input rows with checked grammatical evidence: 213
- Compiled rows with canonical grammatical tags: 213
...
- [x] 6. Parse structured linguistic information — 213 input rows carry checked grammatical evidence; 213 compiled rows carry canonical grammatical tags
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-sil-pahari-pothwari-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_pahari.py, tests/test_sil_pahari_pothwari_2010.py, tests/test_source_checklists.py
