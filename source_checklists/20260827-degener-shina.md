# Source ingestion checklist — 20260827-degener-shina

- Installed input: `data/other/forms/20260827-degener-shina.csv`
...
- [x] 1. Establish the source and scope — source keys: degener-shina2008; 1577 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/degener_shina_2008.py
- [x] 3. Plan the installed files and identifiers — 1577 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1577}; blank forms 0
- [x] 6. Parse structured linguistic information — 1264 input rows carry checked grammatical evidence; 1264 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/degener-shina.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260827-degener-shina-audit.csv, data/other/forms/raw_data/20260827-degener-shina-sample.csv, data/other/forms/raw_data/20260827-degener-shina-manifest.json, data/other/forms/raw_data/20260827-degener-shina-transcription.txt, data/other/forms/raw_data/20260827-degener-shina-editorial.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_degener_shina.py, tests/test_source_checklists.py
...
- Representative app entries: `/entries/f_f6wf6mkbfovjm` (ordinary unlinked abáak), `/entries/f_fckikyqkpmuye` (Turner-linked baál), `/entries/f_7hg6idrbuqj6w` (resolved cross-reference variant kheer-), and `/references/degener-shina2008`.
