# Source ingestion checklist — 20260813-kudiya

- Installed input: `data/other/forms/20260813-kudiya.csv`
...
- Installed rows: 409
- Compiled rows carrying this unit's citation keys: 397
- Source keys: joseph2024kudiya

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: joseph2024kudiya; 409 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/kudiya.py
- [x] 3. Plan the installed files and identifiers — 409 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 409}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/kudiya.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kudiya.py, tests/test_source_checklists.py
...
- Counts: 409 installed records; 397 compiled citation attestations.
...
- Transcription: `conversion/kudiya.txt`.
