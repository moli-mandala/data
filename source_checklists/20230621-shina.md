# Source ingestion checklist — 20230621-shina

- Installed input: `data/other/forms/20230621-shina.csv`
...
- [x] 1. Establish the source and scope — source keys: schmidt; 2050 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/link_northern_shina_database.py, data/other/forms/raw_data/link_schmidt_shina_database.py, data/other/forms/raw_data/shina.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 2050}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/liljegren.txt; replacement characters in input forms: 0
...
- Counts: 2050 installed records; 3129 compiled citation attestations.
...
- Transcription: `conversion/liljegren.txt`.
