...
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/buddruss_shina_1996.py, data/other/forms/raw_data/degener_shina_2008.py, data/other/forms/raw_data/link_northern_shina_database.py, data/other/forms/raw_data/link_schmidt_shina_database.py, data/other/forms/raw_data/shina.py
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260827-degener-shina-audit.csv, data/other/forms/raw_data/20260828-buddruss-shina-raetsel-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_buddruss_shina_1996.py, tests/test_degener_shina.py, tests/test_source_checklists.py
