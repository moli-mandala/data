# Source ingestion checklist — 20260804-andersen-mre

- Installed input: `data/other/forms/20260804-andersen-mre.csv`
...
- [x] 1. Establish the source and scope — source keys: andersen1990; 287 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/andersen_mre.py
...
- [x] 11. Add focused regression tests — tests: tests/test_andersen_mre.py, tests/test_source_checklists.py
...
- Counts: 287 installed records; 279 compiled citation attestations.
...
- Transcription: `conversion/andersen.txt`.
