# Source ingestion checklist — 20260813-bhaskararao-toda

- Installed input: `data/other/forms/20260813-bhaskararao-toda.csv`
...
- Installed rows: 8859
- Compiled rows carrying this unit's citation keys: 8879
- Source keys: bhaskararao-toda-notes, bhaskararao-toda2025, emeneau-toda1984

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: bhaskararao-toda-notes, bhaskararao-toda2025, emeneau-toda1984; 8859 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/bhaskararao_toda.py
- [x] 3. Plan the installed files and identifiers — 8859 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 8859}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/toda.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-bhaskararao-toda-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_bhaskararao_toda.py, tests/test_source_checklists.py
...
- Counts: 8859 installed records; 8879 compiled citation attestations.
- Exclusions: 2 of 7,560 dictionary records have replacement-glyph-only heads and remain audit-only; 7,558 readable records emit 8,859 installed rows after variant expansion.
- Unresolved cases: the 2 corrupt heads are preserved without conjectural reconstruction.
- Transcription: `conversion/toda.txt`.
