# Source ingestion checklist — 20260725-schmidt-kashmiri

- Installed input: `data/other/forms/20260725-schmidt-kashmiri.csv`
...
- Installed rows: 1149
- Compiled rows carrying this unit's citation keys: 3129
- Source keys: schmidt

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: schmidt; 1149 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/build_schmidt_kashmiri.py, data/other/forms/raw_data/build_schmidt_missing.py, data/other/forms/raw_data/extract_schmidt_kashmiri.py, data/other/forms/raw_data/extract_schmidt_missing.py, data/other/forms/raw_data/link_schmidt_shina_database.py, data/other/forms/raw_data/review_schmidt_kashmiri.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 1149}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/schmidt-kashmiri.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_schmidt_kashmiri.py, tests/test_source_checklists.py
...
- Counts: 1149 installed records; 3129 compiled citation attestations.
...
- Transcription: `conversion/schmidt-kashmiri.txt`.
