# Source ingestion checklist — 20260826-sil-koch

- Installed input: `data/other/forms/20260826-sil-koch.csv`
...
- Installed rows: 2281
- Compiled rows carrying this unit's citation keys: 2281
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: kondakov2011koch

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kondakov2011koch; 2281 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sil_koch_2011.py
- [x] 3. Plan the installed files and identifiers — 2281 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 3 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2281}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-koch.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260826-sil-koch-audit.csv, data/other/forms/raw_data/20260826-sil-kochbd-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_koch_2011.py, tests/test_sil_kochbd_2011_manual.py, tests/test_sil_kochbd_2011_post_freeze.py, tests/test_source_checklists.py
...
- Counts: 2281 installed records; 2281 compiled citation attestations.
...
- Transcription: `conversion/sil-koch.txt`.
