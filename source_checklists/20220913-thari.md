# Source ingestion checklist — 20220913-thari

- Installed input: `data/other/forms/20220913-thari.csv`
...
- Installed rows: 320
- Compiled rows carrying this unit's citation keys: 328
- Source keys: arora, thari

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: arora, thari; 320 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/thari.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 316, '9': 4}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260817-thari-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_thari_ocr.py, tests/test_source_checklists.py
...
- Counts: 320 installed records; 328 compiled citation attestations.
