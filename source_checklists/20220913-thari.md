...
- Installed rows: 320
- Compiled rows carrying this unit's citation keys: 332
- Input rows with checked grammatical evidence: 205
- Compiled rows with canonical grammatical tags: 204
...
- [x] 3. Plan the installed files and identifiers — 258 unique immutable Entry_Key values
...
- [x] 6. Parse structured linguistic information — 205 input rows carry checked grammatical evidence; 204 compiled rows carry canonical grammatical tags
...
- Counts: 320 installed records; 332 compiled citation attestations.
