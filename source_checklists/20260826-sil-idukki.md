# Source ingestion checklist — 20260826-sil-idukki

- Installed input: `data/other/forms/20260826-sil-idukki.csv`
...
- Installed rows: 4630
- Compiled rows carrying this unit's citation keys: 4630
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: varghese-mathew2015idukki

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: varghese-mathew2015idukki; 4630 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/20260826-sil-idukki.csv
- [x] 3. Plan the installed files and identifiers — 4630 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 4630}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-survey.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260826-sil-idukki-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 4630 installed records; 4630 compiled citation attestations.
...
- Transcription: `conversion/sil-survey.txt`.
