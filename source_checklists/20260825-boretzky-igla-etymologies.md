# Source ingestion checklist — 20260825-boretzky-igla-etymologies

- Installed input: `data/other/forms/20260825-boretzky-igla-etymologies.csv`
...
- Compiled rows with canonical grammatical tags: 1065
...
- [x] 1. Establish the source and scope — source keys: barannikov1934gypsy, bischoff1827woerterbuch, boretzky1994romani, colocci1889zingari, finck1903zigeuner, heinschink1989izmir, jesina1886romanicib, lipa1963cikanstina, paspati1870tchinghianes, rozwadowski1936zakopane, sampson1926welsh, sowa1898zigeuner, thesleff1901finnland; 1140 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/boretzky_igla_1994.py
...
- [x] 6. Parse structured linguistic information — 1114 input rows carry checked grammatical evidence; 1065 compiled rows carry canonical grammatical tags
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-boretzky-igla-etymologies-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_boretzky_igla.py, tests/test_manual_survey_etymologies.py, tests/test_source_checklists.py
...
- Counts: 1140 installed records; 1129 compiled citation attestations.
...
- Transcription: `conversion/boretzky-romani.txt`.
