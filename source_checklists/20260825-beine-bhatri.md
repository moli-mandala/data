# Source ingestion checklist — 20260825-beine-bhatri

- Installed input: `data/other/forms/20260825-beine-bhatri.csv`
...
- Installed rows: 2492
- Compiled rows carrying this unit's citation keys: 2492
- Input rows with checked grammatical evidence: 23
- Compiled rows with canonical grammatical tags: 23
- Source keys: beine2017bhatri

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: beine2017bhatri; 2492 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/beine_bhatri.py, data/other/forms/raw_data/gondi_beine.py
- [x] 3. Plan the installed files and identifiers — 2492 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 12 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2492}; blank forms 0
- [x] 6. Parse structured linguistic information — 23 input rows carry checked grammatical evidence; 23 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/beine-bhatri.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-beine-bhatri-audit.csv, data/other/forms/raw_data/20260825-gondi-beine-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_beine_bhatri.py, tests/test_gondi_beine.py, tests/test_source_checklists.py
...
- Counts: 2492 installed records; 2492 compiled citation attestations.
...
- Transcription: `conversion/beine-bhatri.txt`.
