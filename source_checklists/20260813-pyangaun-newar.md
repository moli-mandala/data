# Source ingestion checklist — 20260813-pyangaun-newar

- Installed input: `data/other/forms/20260813-pyangaun-newar.csv`
...
- Installed rows: 338
- Compiled rows carrying this unit's citation keys: 317
- Source keys: smith2021pyangaun

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: smith2021pyangaun; 338 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/pyangaun_newar.py
- [x] 3. Plan the installed files and identifiers — 338 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 338}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/pyangaun-newar.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_pyangaun_newar.py, tests/test_source_checklists.py
...
- Counts: 338 installed records; 317 compiled citation attestations.
...
- Transcription: `conversion/pyangaun-newar.txt`.
