# Source ingestion checklist — 20260813-mustang-loke

- Installed input: `data/other/forms/20260813-mustang-loke.csv`
...
- Installed rows: 1996
- Compiled rows carrying this unit's citation keys: 1802
- Source keys: khadgi-marcuson-marcuson2021mustang

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: khadgi-marcuson-marcuson2021mustang; 1996 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/mustang_loke.py
- [x] 3. Plan the installed files and identifiers — 1996 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1996}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/mustang-loke.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_mustang_loke.py, tests/test_source_checklists.py
...
- Counts: 1996 installed records; 1802 compiled citation attestations.
...
- Transcription: `conversion/mustang-loke.txt`.
