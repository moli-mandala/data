# Source ingestion checklist — 20220913-vaagri

- Installed input: `data/other/forms/20220913-vaagri.csv`
...
- Installed rows: 2456
- Compiled rows carrying this unit's citation keys: 2427
- Source keys: srinivasa

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: srinivasa; 2456 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/vaagri.py
- [x] 3. Plan the installed files and identifiers — 2301 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2456}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/vaagri.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_vaagri.py, tests/test_source_checklists.py
...
- Counts: 2456 installed records; 2427 compiled citation attestations.
...
- Transcription: `conversion/vaagri.txt`.
