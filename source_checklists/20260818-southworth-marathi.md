# Source ingestion checklist — 20260818-southworth-marathi

- Installed input: `data/other/forms/20260818-southworth-marathi.csv`
...
- Installed rows: 30
- Compiled rows carrying this unit's citation keys: 62
- Source keys: southworth2005m

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: southworth2005m; 30 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/southworth_marathi.py
- [x] 3. Plan the installed files and identifiers — 30 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 30}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/southworth-marathi.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260818-southworth2005m-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_southworth_marathi.py, tests/test_source_checklists.py
...
- Counts: 30 installed records; 62 compiled citation attestations.
...
- Transcription: `conversion/southworth-marathi.txt`.
