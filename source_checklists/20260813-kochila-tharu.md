# Source ingestion checklist — 20260813-kochila-tharu

- Installed input: `data/other/forms/20260813-kochila-tharu.csv`
...
- [x] 5. Emit the rich import schema — row widths {'11': 833}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/kochila-tharu.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kochila_tharu.py, tests/test_tharu.py, tests/test_source_checklists.py
