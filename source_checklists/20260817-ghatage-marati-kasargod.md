# Source ingestion checklist — 20260817-ghatage-marati-kasargod

- Installed input: `data/other/forms/20260817-ghatage-marati-kasargod.csv`
- Canonical checklist SHA-256: `c0254863d2a149b3fdfd6ea9c155d957d24fb61e74c2a53c3e0e90e455da0063`
- Source-type addenda: Dictionary or glossary, OCR-heavy source
- Installed rows: 1271
- Compiled rows carrying this unit's citation keys: 1247
- Source keys: ghatage-kasargod1970

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: ghatage-kasargod1970; 1271 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/ghatage_survey.py
- [x] 3. Plan the installed files and identifiers — 1271 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1271}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/ghatage.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260817-ghatage-marati-kasargod-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_ghatage_survey.py, tests/test_source_checklists.py
...
- Counts: 1271 installed records; 1247 compiled citation attestations.
- Exclusions: 1 corrupt alternate candidate remains audit-only while its readable main form is installed.
- Unresolved cases: 1,115 OCR records remain explicitly unreviewed; 129 are source-image verified, and the deterministic 20-record sample passes after correction.
- Transcription: `conversion/ghatage.txt`; every installed form retains `ocr-review`, and the source is marked OCR in the browser bibliography.
- Validation: final full data/browser validation is recorded centrally in `source_checklists/VALIDATION.md`.
- Representative app entries: `/references/ghatage-kasargod1970`, `/entries/f_zgcmreutdcjxa`, and `/concepts/2398`.
