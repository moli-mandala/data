# Source ingestion checklist — 20260813-magar-2024

- Installed input: `data/other/forms/20260813-magar-2024.csv`
...
- Installed rows: 1769
- Compiled rows carrying this unit's citation keys: 1769
- Source keys: swenson2024magar

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: swenson2024magar; 1769 installed records
...
- [x] 3. Plan the installed files and identifiers — 1769 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 12 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1769}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/magar-2024.txt; replacement characters in input forms: 0
...
- Counts: 1769 installed records; 1769 compiled citation attestations.
...
- Transcription: `conversion/magar-2024.txt`.
