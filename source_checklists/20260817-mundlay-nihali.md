# Source ingestion checklist — 20260817-mundlay-nihali

- Installed input: `data/other/forms/20260817-mundlay-nihali.csv`
...
- Source keys: mundlay1996, nihali-database2026

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: mundlay1996, nihali-database2026; 1707 installed records
...
- [x] 3. Plan the installed files and identifiers — 1707 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1707}; blank forms 0
...
- Counts: 1707 installed records; 4065 compiled citation attestations.
