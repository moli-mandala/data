# Source ingestion checklist — 20260810-tulpule-old-marathi

- Installed input: `data/other/forms/20260810-tulpule-old-marathi.csv`
...
- Installed rows: 4718
- Compiled rows carrying this unit's citation keys: 4718
- Source keys: tulpule1999

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: tulpule1999; 4718 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/southworth_marathi.py, data/other/forms/raw_data/tulpule.py
- [x] 3. Plan the installed files and identifiers — 4718 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 4718}; blank forms 0
...
- [x] 11. Add focused regression tests — tests: tests/test_southworth_marathi.py, tests/test_tulpule.py, tests/test_source_checklists.py
...
- Counts: 4718 installed records; 4718 compiled citation attestations.
