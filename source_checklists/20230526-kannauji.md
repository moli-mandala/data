# Source ingestion checklist — 20230526-kannauji

- Installed input: `data/other/forms/20230526-kannauji.csv`
...
- Installed rows: 3033
- Compiled rows carrying this unit's citation keys: 3033
- Source keys: kannauji

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kannauji; 3033 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/kannauji.py
- [x] 3. Plan the installed files and identifiers — 3033 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 13 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 3033}; blank forms 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kannauji.py, tests/test_source_checklists.py
...
- Counts: 3033 installed records; 3033 compiled citation attestations.
