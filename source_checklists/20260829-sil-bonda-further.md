# Source ingestion checklist — 20260829-sil-bonda-further

- Installed input: `data/other/forms/20260829-sil-bonda-further.csv`
...
- Installed rows: 644
- Compiled rows carrying this unit's citation keys: 305
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: mathew2022bonda-further

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: mathew2022bonda-further; 644 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/bhattacharya_bonda_1968.py
- [x] 3. Plan the installed files and identifiers — 644 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 644}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-bonda-further.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-bhattacharya-bonda-audit.csv, data/other/forms/raw_data/20260828-sil-bonda-didayi-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_bhattacharya_bonda_1968.py, tests/test_sil_bonda_didayi_2022.py, tests/test_source_checklists.py
...
- Counts: 644 installed records; 305 compiled citation attestations.
...
- Transcription: `conversion/sil-bonda-further.txt`.
