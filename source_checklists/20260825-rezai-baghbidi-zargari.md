# Source ingestion checklist — 20260825-rezai-baghbidi-zargari

- Installed input: `data/other/forms/20260825-rezai-baghbidi-zargari.csv`
...
- Installed rows: 522
- Compiled rows carrying this unit's citation keys: 522
- Input rows with checked grammatical evidence: 522
- Compiled rows with canonical grammatical tags: 522
- Source keys: rezaibaghbidi2003zargari

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: rezaibaghbidi2003zargari; 522 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/rezai_baghbidi_zargari_2003.py
- [x] 3. Plan the installed files and identifiers — 522 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 522}; blank forms 0
- [x] 6. Parse structured linguistic information — 522 input rows carry checked grammatical evidence; 522 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/zargari.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-rezai-baghbidi-zargari-audit.csv, data/other/forms/raw_data/20260825-rezai-baghbidi-zargari-sample.csv, data/other/forms/raw_data/20260825-rezai-baghbidi-zargari-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_rezai_baghbidi_zargari_2003.py, tests/test_source_checklists.py
...
- Counts: 522 installed records; 522 compiled citation attestations.
...
- Transcription: `conversion/zargari.txt`.
