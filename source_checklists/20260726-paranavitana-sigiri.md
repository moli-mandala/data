...
- Input rows with checked grammatical evidence: 2058
- Compiled rows with canonical grammatical tags: 1949
...
- [x] 5. Emit the rich import schema — row widths {'15': 2874}; blank forms 0
- [x] 6. Parse structured linguistic information — 2058 input rows carry checked grammatical evidence; 1949 compiled rows carry canonical grammatical tags
