# Source ingestion checklist — 20260726-paranavitana-sigiri

- Installed input: `data/other/forms/20260726-paranavitana-sigiri.csv`
- Canonical checklist SHA-256: `c0254863d2a149b3fdfd6ea9c155d957d24fb61e74c2a53c3e0e90e455da0063`
- Source-type addenda: OCR-heavy source, Etymological/comparative source
- Installed rows: 2874
- Compiled rows carrying this unit's citation keys: 2743
- Source keys: paranavitana

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: paranavitana; 2874 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sigiri.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 2874}; blank forms 0
...
- [x] 11. Add focused regression tests — tests: tests/test_sigiri.py, tests/test_source_checklists.py
...
- Counts: 2874 installed records; 2743 compiled citation attestations.
