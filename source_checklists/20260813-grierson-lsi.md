# Source ingestion checklist — 20260813-grierson-lsi

- Installed input: `data/other/forms/20260813-grierson-lsi.csv`
...
- [x] 1. Establish the source and scope — source keys: grierson-lsi1928; 28552 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/grierson_lsi.py
- [x] 3. Plan the installed files and identifiers — 28552 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 153 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 28552}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/lsi.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-grierson-lsi-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_grierson_lsi.py, tests/test_source_checklists.py
