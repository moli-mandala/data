# Source ingestion checklist — 20260813-ali-kobayashi-brahui

- Installed input: `data/other/forms/20260813-ali-kobayashi-brahui.csv`
...
- Installed rows: 3483
- Compiled rows carrying this unit's citation keys: 3368
- Source keys: ali-kobayashi2024

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: ali-kobayashi2024; 3483 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/ali_kobayashi_brahui.py
- [x] 3. Plan the installed files and identifiers — 3483 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 3483}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/brahui.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-ali-kobayashi-brahui-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_ali_kobayashi_brahui.py, tests/test_source_checklists.py
...
- Counts: 3483 installed records; 3368 compiled citation attestations.
...
- Transcription: `conversion/brahui.txt`.
