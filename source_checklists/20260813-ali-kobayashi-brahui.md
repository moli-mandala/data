...
- Input rows with checked grammatical evidence: 3483
- Compiled rows with canonical grammatical tags: 3368
...
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/ali_kobayashi_brahui.py, data/other/forms/raw_data/emeneau_brahui_1997.py
...
- [x] 6. Parse structured linguistic information — 3483 input rows carry checked grammatical evidence; 3368 compiled rows carry canonical grammatical tags
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-ali-kobayashi-brahui-audit.csv, data/other/forms/raw_data/20260819-emeneau-brahui-1997-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_ali_kobayashi_brahui.py, tests/test_emeneau_brahui_1997.py, tests/test_source_checklists.py
