# Source ingestion checklist — 20260725-kalasha-trail-cooper

- Installed input: `data/other/forms/20260725-kalasha-trail-cooper.csv`
...
- Installed rows: 6102
- Compiled rows carrying this unit's citation keys: 6092
- Source keys: trail-cooper1999

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: trail-cooper1999; 6102 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/kalasha.py
- [x] 3. Plan the installed files and identifiers — 6102 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 13 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 6102}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/kalasha.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_kalasha.py, tests/test_source_checklists.py
...
- Counts: 6102 installed records; 6092 compiled citation attestations.
...
- Transcription: `conversion/kalasha.txt`.
