# Source ingestion checklist — 20230522-bundeli

- Installed input: `data/other/forms/20230522-bundeli.csv`
...
- Installed rows: 5759
- Compiled rows carrying this unit's citation keys: 5563
- Source keys: bundeli

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: bundeli; 5759 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/bundeli.py
- [x] 3. Plan the installed files and identifiers — 0 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 25 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'8': 5759}; blank forms 0
...
- Counts: 5759 installed records; 5563 compiled citation attestations.
