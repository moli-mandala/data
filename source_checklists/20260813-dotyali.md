# Source ingestion checklist — 20260813-dotyali

- Installed input: `data/other/forms/20260813-dotyali.csv`
...
- Source keys: eichentopf-tupper2019dotyali

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: eichentopf-tupper2019dotyali; 1270 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/dotyali.py
- [x] 3. Plan the installed files and identifiers — 1270 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1270}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/dotyali.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_dotyali.py, tests/test_source_checklists.py
...
- Counts: 1270 installed records; 1247 compiled citation attestations.
...
- Transcription: `conversion/dotyali.txt`.
