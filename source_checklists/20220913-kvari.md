# Source ingestion checklist — 20220913-kvari

- Installed input: `data/other/forms/20220913-kvari.csv`
...
- Installed rows: 216
- Compiled rows carrying this unit's citation keys: 215
- Source keys: jouanne

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: jouanne; 216 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/legacy_snapshots.py
- [x] 3. Plan the installed files and identifiers — 216 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 216}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: source_checklists/audits/20220913-kvari-snapshot-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 216 installed records; 215 compiled citation attestations.
