# Source ingestion checklist — 20260813-chhulung

- Installed input: `data/other/forms/20260813-chhulung.csv`
...
- Installed rows: 970
- Compiled rows carrying this unit's citation keys: 970
- Source keys: rai-rai-thokar2014chhulung

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: rai-rai-thokar2014chhulung; 970 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/chhulung_2014.py
- [x] 3. Plan the installed files and identifiers — 970 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 970}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/chhulung.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_chhulung_2014.py, tests/test_source_checklists.py
...
- Counts: 970 installed records; 970 compiled citation attestations.
...
- Transcription: `conversion/chhulung.txt`.
