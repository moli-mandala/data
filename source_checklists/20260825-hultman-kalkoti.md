# Source ingestion checklist — 20260825-hultman-kalkoti

- Installed input: `data/other/forms/20260825-hultman-kalkoti.csv`
...
- Installed rows: 475
- Compiled rows carrying this unit's citation keys: 475
- Input rows with checked grammatical evidence: 347
- Compiled rows with canonical grammatical tags: 347
- Source keys: hultman2023kalkoti

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: hultman2023kalkoti; 475 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/hultman_kalkoti_2023.py, data/other/forms/raw_data/liljegren_kalkoti_2013.py
- [x] 3. Plan the installed files and identifiers — 475 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 475}; blank forms 0
- [x] 6. Parse structured linguistic information — 347 input rows carry checked grammatical evidence; 347 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/kalkoti.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-hultman-kalkoti-audit.csv, data/other/forms/raw_data/20260825-liljegren-kalkoti-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_hultman_kalkoti.py, tests/test_liljegren_kalkoti.py, tests/test_source_checklists.py
...
- Counts: 475 installed records; 475 compiled citation attestations.
...
- Transcription: `conversion/kalkoti.txt`.
