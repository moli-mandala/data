# Source ingestion checklist — 20260813-yamphu

- Installed input: `data/other/forms/20260813-yamphu.csv`
...
- Installed rows: 2188
- Compiled rows carrying this unit's citation keys: 2099
- Source keys: hilty-mitchell2014

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: hilty-mitchell2014; 2188 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/yamphu.py
- [x] 3. Plan the installed files and identifiers — 2188 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 9 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 2188}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/yamphu.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_yamphu.py, tests/test_source_checklists.py
...
- Counts: 2188 installed records; 2099 compiled citation attestations.
...
- Transcription: `conversion/yamphu.txt`.
