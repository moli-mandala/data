# Source ingestion checklist — 20260813-majhi-bote

- Installed input: `data/other/forms/20260813-majhi-bote.csv`
...
- Installed rows: 1590
- Compiled rows carrying this unit's citation keys: 1546
- Source keys: page2024majhi-bote

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: page2024majhi-bote; 1590 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/majhi_bote.py
...
- [x] 11. Add focused regression tests — tests: tests/test_majhi_bote.py, tests/test_source_checklists.py
...
- Counts: 1590 installed records; 1546 compiled citation attestations.
...
- Transcription: `conversion/majhi-bote.txt`.
