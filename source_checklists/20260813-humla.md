# Source ingestion checklist — 20260813-humla

- Installed input: `data/other/forms/20260813-humla.csv`
...
- Installed rows: 1512
- Compiled rows carrying this unit's citation keys: 1413
- Source keys: devries2020humla

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: devries2020humla; 1512 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/humla.py
...
- [x] 5. Emit the rich import schema — row widths {'11': 1512}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/humla.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_humla.py, tests/test_source_checklists.py
...
- Counts: 1512 installed records; 1413 compiled citation attestations.
...
- Transcription: `conversion/humla.txt`.
