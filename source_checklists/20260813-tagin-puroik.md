# Source ingestion checklist — 20260813-tagin-puroik

- Installed input: `data/other/forms/20260813-tagin-puroik.csv`
...
- Installed rows: 4939
- Compiled rows carrying this unit's citation keys: 4648
- Source keys: abraham-sako2021

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: abraham-sako2021; 4939 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/tagin_puroik.py
- [x] 3. Plan the installed files and identifiers — 4939 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 16 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 4939}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/tagin-puroik.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_tagin_puroik.py, tests/test_source_checklists.py
...
- Counts: 4939 installed records; 4648 compiled citation attestations.
...
- Transcription: `conversion/tagin-puroik.txt`.
