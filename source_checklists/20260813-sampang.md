# Source ingestion checklist — 20260813-sampang

- Installed input: `data/other/forms/20260813-sampang.csv`
...
- Installed rows: 907
- Compiled rows carrying this unit's citation keys: 907
- Source keys: rai-rai-thokar2015sampang

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: rai-rai-thokar2015sampang; 907 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sampang_2015.py
- [x] 3. Plan the installed files and identifiers — 907 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 907}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/sampang.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_sampang_2015.py, tests/test_source_checklists.py
...
- Counts: 907 installed records; 907 compiled citation attestations.
...
- Transcription: `conversion/sampang.txt`.
