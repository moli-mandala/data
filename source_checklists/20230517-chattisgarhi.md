# Source ingestion checklist — 20230517-chattisgarhi

- Installed input: `data/other/forms/20230517-chattisgarhi.csv`
...
- Installed rows: 2733
- Compiled rows carrying this unit's citation keys: 2682
- Source keys: chattisgarhi

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: chattisgarhi; 2733 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/chattisgarhi.py
- [x] 3. Plan the installed files and identifiers — 0 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 11 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'8': 2733}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/chattisgarhi.txt; replacement characters in input forms: 0
...
- Counts: 2733 installed records; 2682 compiled citation attestations.
...
- Transcription: `conversion/chattisgarhi.txt`.
