# Source ingestion checklist — 20260723-markodi

- Installed input: `data/other/forms/20260723-markodi.csv`
...
- Installed rows: 615
- Compiled rows carrying this unit's citation keys: 612
- Source keys: canvin2025

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: canvin2025; 615 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/markodi.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 615}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/markodi.txt; replacement characters in input forms: 0
...
- Counts: 615 installed records; 612 compiled citation attestations.
...
- Transcription: `conversion/markodi.txt`.
