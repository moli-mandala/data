# Source ingestion checklist — 20260726-yoshioka-eastern-burushaski
...
- [x] 11. Add focused regression tests — tests: tests/test_burushaski_cognates.py, tests/test_eastern_magar.py, tests/test_yoshioka.py, tests/test_source_checklists.py
