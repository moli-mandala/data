# Source ingestion checklist — 20260813-eastern-magar

- Installed input: `data/other/forms/20260813-eastern-magar.csv`
...
- Installed rows: 865
- Compiled rows carrying this unit's citation keys: 842
- Source keys: hilty2013eastern-magar

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: hilty2013eastern-magar; 865 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/eastern_magar.py, data/other/forms/raw_data/magar_2024.py
- [x] 3. Plan the installed files and identifiers — 865 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 865}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/eastern-magar.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_eastern_magar.py, tests/test_magar_2024.py, tests/test_source_checklists.py
...
- Counts: 865 installed records; 842 compiled citation attestations.
...
- Transcription: `conversion/eastern-magar.txt`.
