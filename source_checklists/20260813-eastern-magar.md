...
- Input rows with checked grammatical evidence: 4
- Compiled rows with canonical grammatical tags: 4
...
- [x] 6. Parse structured linguistic information — 4 input rows carry checked grammatical evidence; 4 compiled rows carry canonical grammatical tags
...
- [x] 11. Add focused regression tests — tests: tests/test_eastern_magar.py, tests/test_magar_2024.py, tests/test_sil_eastern_gujari_2023.py, tests/test_source_checklists.py
