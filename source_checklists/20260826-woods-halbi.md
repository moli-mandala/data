# Source ingestion checklist — 20260826-woods-halbi

- Installed input: `data/other/forms/20260826-woods-halbi.csv`
- Canonical checklist SHA-256: `23516ba5c7caeaa5310f6a32d92b86e4b9ae5e4479e792926b61dd0689129f05`
- Source-type addenda: Dictionary or glossary, Website/API or external CLDF
- Installed rows: 7773
- Compiled rows carrying this unit's citation keys: 7773
- Input rows with checked grammatical evidence: 3202
- Compiled rows with canonical grammatical tags: 3202
- Source keys: woods2019halbi

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: woods2019halbi; 7773 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/woods_halbi.py
- [x] 3. Plan the installed files and identifiers — 7773 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 7773}; blank forms 0
- [x] 6. Parse structured linguistic information — 3202 input rows carry checked grammatical evidence; 3202 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/halbi-woods.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260826-woods-halbi-audit.csv, data/other/forms/raw_data/20260826-woods-halbi-sample.csv, data/other/forms/raw_data/20260826-woods-halbi-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_woods_halbi.py, tests/test_source_checklists.py
...
- Counts: 7773 installed records; 7773 compiled citation attestations.
...
- Transcription: `conversion/halbi-woods.txt`.
