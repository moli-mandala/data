# Source ingestion checklist — 20260813-wolf-kota

- Installed input: `data/other/forms/20260813-wolf-kota.csv`
...
- Installed rows: 2152
- Compiled rows carrying this unit's citation keys: 2152
- Source keys: wolf-kota

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: wolf-kota; 2152 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/20260813-wolf-kota.csv
- [x] 3. Plan the installed files and identifiers — 2152 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2152}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-wolf-kota-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 2152 installed records; 2152 compiled citation attestations.
