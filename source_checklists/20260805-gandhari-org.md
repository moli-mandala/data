# Source ingestion checklist — 20260805-gandhari-org

- Installed input: `data/other/forms/20260805-gandhari-org.csv`
- Canonical checklist SHA-256: `c0254863d2a149b3fdfd6ea9c155d957d24fb61e74c2a53c3e0e90e455da0063`
- Source-type addenda: Dictionary or glossary, Website/API or external CLDF, Etymological/comparative source
- Installed rows: 1512
- Compiled rows carrying this unit's citation keys: 1512
- Source keys: gandhari

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: gandhari; 1512 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/gandhari_org.py
- [x] 3. Plan the installed files and identifiers — 1512 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1512}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/gandhari.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260805-gandhari-org-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_gandhari_org.py, tests/test_source_checklists.py
...
- Counts: 1512 installed records; 1512 compiled citation attestations.
- Exclusions: of 5,807 Sanskrit-bearing API articles, 371 ambiguous matches, 3,923 unmatched articles, and 1 article without a parsed Sanskrit etymon remain audit-only; 1,512 unique exact accent-normalized CDIAL matches are installed.
- Unresolved cases: the 4,295 non-unique or unmatched CDIAL assignments remain conservatively unlinked in the audit; source-site reuse terms were not stated.
- Transcription: `conversion/gandhari.txt`; source spelling, Kharoshthi, and phonetic fields remain separate, with full paradigms retained only in the audit.
- Validation: final full data/browser validation is recorded centrally in `source_checklists/VALIDATION.md`.
- Representative app entries: `/entries/f_d3zfp2ruszaq6` (ichadi), `/entries/f_uo5sns6fnvzse` (relative pronoun yavaṁta), `/languages/Dhp`, `/references/gandhari`, and `/concepts/2960`.
