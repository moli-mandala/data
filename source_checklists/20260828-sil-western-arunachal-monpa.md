# Source ingestion checklist — 20260828-sil-western-arunachal-monpa

- Installed input: `data/other/forms/20260828-sil-western-arunachal-monpa.csv`
...
- Installed rows: 9279
- Compiled rows carrying this unit's citation keys: 6319
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: abraham-sako-kinny-zeliang2018

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: abraham-sako-kinny-zeliang2018; 9279 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/abraham_monpa_2018/import_abraham_monpa.py
- [x] 3. Plan the installed files and identifiers — 9279 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 12 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 9279}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-sil-western-arunachal-monpa-audit.csv, data/other/forms/raw_data/20260828-sil-western-arunachal-monpa-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_abraham_monpa_2018.py, tests/test_source_checklists.py
...
- Counts: 9279 installed records; 6319 compiled citation attestations.
