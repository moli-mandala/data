# Source ingestion checklist — 20260813-santali-cluster

- Installed input: `data/other/forms/20260813-santali-cluster.csv`
...
- Installed rows: 4882
- Compiled rows carrying this unit's citation keys: 4882
- Source keys: kim-kim-ahmad-sangma2010santali-cluster

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kim-kim-ahmad-sangma2010santali-cluster; 4882 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/santali_cluster_2010.py
- [x] 3. Plan the installed files and identifiers — 4882 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 16 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 4882}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/santali-cluster.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_santali_cluster_2010.py, tests/test_source_checklists.py
...
- Counts: 4882 installed records; 4882 compiled citation attestations.
...
- Transcription: `conversion/santali-cluster.txt`.
