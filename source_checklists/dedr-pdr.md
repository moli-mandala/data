# Source ingestion checklist — dedr-pdr

- Installed input: `data/dedr/pdr.csv`
...
- Installed rows: 1365
- Compiled rows carrying this unit's citation keys: 1405
- Source keys: kobayashi2022, krishnamurti, pfeiffer2018, southworth2005m, southworth2006proto

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kobayashi2022, krishnamurti, pfeiffer2018, southworth2005m, southworth2006proto; 1365 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/dedr/get_params.py
...
- [x] 5. Emit the rich import schema — row widths {'9': 1365}; blank forms 0
...
- [x] 11. Add focused regression tests — tests: tests/test_dedr_variants.py, tests/test_cldf.py
...
- Counts: 1365 installed records; 1405 compiled citation attestations.
