# Source ingestion checklist — 20230521-rajasthani
...
- Installed rows: 16564
- Compiled rows carrying this unit's citation keys: 15752
- Source keys: bagri, dhundari, hadothi, marwari, mewari, mewati

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: bagri, dhundari, hadothi, marwari, mewari, mewati; 16564 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/20230521-rajasthani.csv
- [x] 3. Plan the installed files and identifiers — 0 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 63 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'8': 16564}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/rajasthani.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: source_checklists/audits/20230521-rajasthani-exclusions.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 16564 installed records; 15752 compiled citation attestations.
