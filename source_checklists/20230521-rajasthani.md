...
- [x] 1. Establish the source and scope — source keys: bagri, dhundari, hadothi, marwari, mewari, mewati; 16522 installed records
...
- [x] 5. Emit the rich import schema — row widths {'8': 16522}; blank forms 0
- [x] 6. Parse structured linguistic information — 653 input rows carry checked grammatical evidence; 582 compiled rows carry canonical grammatical tags
...
- [x] 11. Add focused regression tests — tests: tests/test_rajasthani.py, tests/test_source_checklists.py
