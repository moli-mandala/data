# Source ingestion checklist — 20260718-merriam-dravidian-db

- Installed input: `data/other/forms/20260718-merriam-dravidian-db.csv`
- Canonical checklist SHA-256: `23516ba5c7caeaa5310f6a32d92b86e4b9ae5e4479e792926b61dd0689129f05`
- Source-type addenda: Website/API or external CLDF, Etymological/comparative source
- Installed rows: 6672
- Compiled rows carrying this unit's citation keys: 7943
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 2
- Source keys: krishnamurti, merriam2026dravidiandb, starostin2006dravidian
...
- [x] 7. Build and verify the sound profile — profile route: conversion/merriam-reconstruction.txt; replacement characters in input forms: 0
...
- Counts: 6672 installed records; 7943 compiled citation attestations.
- Exclusions: 17 records under 13 integer DEDR numbers are excluded because those numbers conflate the distinct DEDR N and N-A entries; eight records whose numeric DEDR slots do not exist are also retained only in the audit.
- Unresolved cases: six source records numbered 0 are installed as explicitly unlinked reconstructions; no target is inferred for the eight absent DEDR slots or the letter-suffix collisions.
- Transcription: `conversion/merriam-reconstruction.txt` identity-preserves the source's mixed Starostin, Krishnamurti, and Merriam notation; Original remains diplomatic and display Form receives only the reconstruction marker.
...
- Representative app entries: the Proto-Kurukh–Malto, Proto-South Dravidian I/II, Proto-Central Dravidian, Proto-Northern Dravidian, Proto-South Total Dravidian, and Proto-Dravidian entries cited by `merriam2026dravidiandb`.
