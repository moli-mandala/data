# Source ingestion checklist — 20260828-sil-mudhili-gadaba

- Installed input: `data/other/forms/20260828-sil-mudhili-gadaba.csv`
...
- Installed rows: 1538
- Compiled rows carrying this unit's citation keys: 1538
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: adimathara2019mudhili

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: adimathara2019mudhili; 1538 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sil_gadaba_2019/import_gadaba.py
- [x] 3. Plan the installed files and identifiers — 1538 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1538}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-gadaba.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-sil-mudhili-gadaba-audit.csv, data/other/forms/raw_data/20260828-sil-mudhili-gadaba-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_gadaba_2019.py, tests/test_source_checklists.py
...
- Counts: 1538 installed records; 1538 compiled citation attestations.
- Exclusions: eight target cells printed `No Entry`, 214 Srikakulam Telugu control responses, and five prompts printed `DISQUALIFIED` are audit-only; 1,538 target forms install.
- Unresolved cases: two printed question-mark responses remain diplomatic in Phonemic with typed source-raster-unresolved notes; no record is structurally unparsed or unmapped.
- Transcription: `conversion/sil-gadaba.txt`; structural OCR supplied layout only and every IPA form was visually transcribed from quarter-column crops of the 168-dpi source pages.
...
- Representative app entries: Bobbilivalasa item 52 `kaṇḍu`, Bobbilivalasa item 18 `kālgil` with source Phonemic `kɑlgil(pl)`, and Panukuvalasa item 12 `puḍu` with source `puɖʊ?`.
