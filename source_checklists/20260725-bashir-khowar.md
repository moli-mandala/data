# Source ingestion checklist — 20260725-bashir-khowar

- Installed input: `data/other/forms/20260725-bashir-khowar.csv`
...
- Installed rows: 16225
- Compiled rows carrying this unit's citation keys: 16071
- Source keys: bashir2023

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: bashir2023; 16225 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/khowar.py
- [x] 3. Plan the installed files and identifiers — 16225 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 143 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 16225}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/khowar.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260725-bashir-khowar-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_khowar.py, tests/test_source_checklists.py
...
- Counts: 16225 installed records; 16071 compiled citation attestations.
...
- Transcription: `conversion/khowar.txt`.
