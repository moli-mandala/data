# Source ingestion checklist — 20260724-old-punjabi-shackle-auto

- Installed input: `data/other/forms/20260724-old-punjabi-shackle-auto.csv`
...
- Installed rows: 5778
- Compiled rows carrying this unit's citation keys: 5730
- Source keys: shackle-auto

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: shackle-auto; 5778 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/old_punjabi.py, data/other/forms/raw_data/punjabi.py, data/other/forms/raw_data/shackle.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 5778}; blank forms 0
...
- [x] 11. Add focused regression tests — tests: tests/test_shackle.py, tests/test_source_checklists.py
...
- Counts: 5778 installed records; 5730 compiled citation attestations.
