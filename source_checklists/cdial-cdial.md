# Source ingestion checklist — cdial-cdial

- Installed input: `data/cdial/cdial.csv`
...
- [x] 10. Produce a complete audit trail — audit: data/cdial/audit.py, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_cdial_parser.py, tests/test_cdial_metadata.py
...
- Counts: 159811 installed records; 160193 compiled citation attestations.
