# Source ingestion checklist — 20230524-tharu

- Installed input: `data/other/forms/20230524-tharu.csv`
...
- Installed rows: 1921
- Compiled rows carrying this unit's citation keys: 1874
- Source keys: boehm

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: boehm; 1921 installed records
...
- [x] 5. Emit the rich import schema — row widths {'8': 1921}; blank forms 0
...
- Counts: 1921 installed records; 1874 compiled citation attestations.
