...
- Compiled rows with canonical grammatical tags: 53
...
- [x] 6. Parse structured linguistic information — 56 input rows carry checked grammatical evidence; 53 compiled rows carry canonical grammatical tags
...
- [x] 11. Add focused regression tests — tests: tests/test_backstrom_northern_pakistan.py, tests/test_north_gorkha.py, tests/test_sil_northern_dhule_bhils_2013.py, tests/test_source_checklists.py
