# Source ingestion checklist — 20260813-north-gorkha

- Installed input: `data/other/forms/20260813-north-gorkha.csv`
...
- Installed rows: 4269
- Compiled rows carrying this unit's citation keys: 3953
- Source keys: webster2022north-gorkha

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: webster2022north-gorkha; 4269 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/link_northern_nontrivial.py, data/other/forms/raw_data/link_northern_obvious.py, data/other/forms/raw_data/link_northern_shina_database.py, data/other/forms/raw_data/north_gorkha.py, data/other/forms/raw_data/northern.py
...
- [x] 11. Add focused regression tests — tests: tests/test_north_gorkha.py, tests/test_source_checklists.py
...
- Counts: 4269 installed records; 3953 compiled citation attestations.
...
- Transcription: `conversion/north-gorkha.txt`.
