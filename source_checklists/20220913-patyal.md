# Source ingestion checklist — 20220913-patyal

- Installed input: `data/other/forms/20220913-patyal.csv`
...
- Installed rows: 644
- Compiled rows carrying this unit's citation keys: 640
- Source keys: patyal2, patyal3, patyal4, patyal5

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: patyal2, patyal3, patyal4, patyal5; 644 installed records
...
- [x] 10. Produce a complete audit trail — audit: source_checklists/audits/20220913-patyal-snapshot-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 644 installed records; 640 compiled citation attestations.
