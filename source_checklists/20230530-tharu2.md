# Source ingestion checklist — 20230530-tharu2

- Installed input: `data/other/forms/20230530-tharu2.csv`
...
- Installed rows: 3571
- Compiled rows carrying this unit's citation keys: 3217
- Source keys: webster

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: webster; 3571 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/tharu2.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 3571}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: source_checklists/audits/20230530-tharu2-exclusions.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 3571 installed records; 3217 compiled citation attestations.
- Exclusions: 3 historical blank-form rows were removed from the installed input and retained in `source_checklists/audits/20230530-tharu2-exclusions.csv`.
