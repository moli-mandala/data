# Source ingestion checklist — dbia-forms

- Installed input: `data/dbia/forms.csv`
...
- Installed rows: 1694
- Compiled rows carrying this unit's citation keys: 1692
- Source keys: dbia

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: dbia; 1694 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/dbia/parse.py
- [x] 3. Plan the installed files and identifiers — 1694 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 16 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1694}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: data/dbia/parse_audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_dbia.py
...
- Counts: 1694 installed records; 1692 compiled citation attestations.
