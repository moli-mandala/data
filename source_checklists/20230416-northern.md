...
- Input rows with checked grammatical evidence: 94
- Compiled rows with canonical grammatical tags: 83
...
- [x] 6. Parse structured linguistic information — 94 input rows carry checked grammatical evidence; 83 compiled rows carry canonical grammatical tags
...
- [x] 11. Add focused regression tests — tests: tests/test_backstrom_northern_pakistan.py, tests/test_sil_northern_dhule_bhils_2013.py, tests/test_source_checklists.py
