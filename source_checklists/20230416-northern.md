# Source ingestion checklist — 20230416-northern

- Installed input: `data/other/forms/20230416-northern.csv`
...
- Installed rows: 11343
- Compiled rows carrying this unit's citation keys: 10629
- Source keys: backstrom1992

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: backstrom1992; 11343 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/link_northern_nontrivial.py, data/other/forms/raw_data/link_northern_obvious.py, data/other/forms/raw_data/link_northern_shina_database.py, data/other/forms/raw_data/northern.py
- [x] 3. Plan the installed files and identifiers — 0 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 51 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'8': 11343}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/northern.txt; replacement characters in input forms: 0
...
- Counts: 11343 installed records; 10629 compiled citation attestations.
...
- Transcription: `conversion/northern.txt`.
