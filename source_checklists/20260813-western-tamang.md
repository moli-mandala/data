# Source ingestion checklist — 20260813-western-tamang

- Installed input: `data/other/forms/20260813-western-tamang.csv`
...
- Installed rows: 901
- Compiled rows carrying this unit's citation keys: 867
- Source keys: lipp2014western-tamang

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: lipp2014western-tamang; 901 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/western_tamang.py
- [x] 3. Plan the installed files and identifiers — 901 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 3 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 901}; blank forms 0
...
- Counts: 901 installed records; 867 compiled citation attestations.
...
- Transcription: `conversion/western-tamang.txt`.
