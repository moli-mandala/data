# Source ingestion checklist — 20260828-sil-nilgiri-irula

- Installed input: `data/other/forms/20260828-sil-nilgiri-irula.csv`
...
- Installed rows: 2054
- Compiled rows carrying this unit's citation keys: 2054
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: ernest-oleary-kelsall2018irula

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: ernest-oleary-kelsall2018irula; 2054 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sil_irula_2018/import_irula.py
- [x] 3. Plan the installed files and identifiers — 2054 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 2054}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-irula.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-sil-nilgiri-irula-audit.csv, data/other/forms/raw_data/20260828-sil-nilgiri-irula-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_irula_2018.py, tests/test_source_checklists.py
...
- Counts: 2054 installed records; 2054 compiled citation attestations.
- Exclusions: 15 target cells explicitly marked missing, 1,319 neighbouring-language control responses, and 29 layout fragments are audit-only; 2,054 Irula forms are installed.
- Unresolved cases: typed source-raster flags retain the low-resolution distinctions that need future source review; no record is structurally unparsed or unmapped.
- Transcription: `conversion/sil-irula.txt`; structural OCR recovered the table layout and every installed IPA form was manually reviewed against enlarged 67--74 dpi source crops.
...
- Representative app entries: Kunjapanai item 1 `oɖʌmbɨ`, Thaliyur item 4 `muɲʤi`, and Bookapuram item 183 alternate `ʌʋã`.
