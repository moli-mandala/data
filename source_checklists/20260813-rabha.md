...
- Input rows with checked grammatical evidence: 10
- Compiled rows with canonical grammatical tags: 9
...
- [x] 6. Parse structured linguistic information — 10 input rows carry checked grammatical evidence; 9 compiled rows carry canonical grammatical tags
...
- [x] 11. Add focused regression tests — tests: tests/test_rabha.py, tests/test_sil_rabha_2013_manual.py, tests/test_source_checklists.py
