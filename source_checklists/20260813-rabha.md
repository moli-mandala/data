# Source ingestion checklist — 20260813-rabha

- Installed input: `data/other/forms/20260813-rabha.csv`
...
- Installed rows: 400
- Compiled rows carrying this unit's citation keys: 390
- Source keys: kondakov2013rabha

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kondakov2013rabha; 400 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/rabha.py
- [x] 3. Plan the installed files and identifiers — 400 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 400}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/rabha.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_rabha.py, tests/test_source_checklists.py
...
- Counts: 400 installed records; 390 compiled citation attestations.
...
- Transcription: `conversion/rabha.txt`.
