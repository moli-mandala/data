# Source ingestion checklist — 20260813-magahi

- Installed input: `data/other/forms/20260813-magahi.csv`
...
- Installed rows: 1050
- Compiled rows carrying this unit's citation keys: 1050
- Source keys: thakur-thakur2016magahi

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: thakur-thakur2016magahi; 1050 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/magahi_2016.py
- [x] 3. Plan the installed files and identifiers — 1050 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1050}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/magahi-survey.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_magahi_2016.py, tests/test_source_checklists.py
...
- Counts: 1050 installed records; 1050 compiled citation attestations.
...
- Transcription: `conversion/magahi-survey.txt`.
