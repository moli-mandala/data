# Source ingestion checklist — 20260813-weinreich-domaaki

- Installed input: `data/other/forms/20260813-weinreich-domaaki.csv`
...
- Installed rows: 135
- Compiled rows carrying this unit's citation keys: 135
- Source keys: weinreich2008

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: weinreich2008; 135 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/weinreich_domaaki.py
- [x] 3. Plan the installed files and identifiers — 135 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 135}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/weinreich-domaaki.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260813-weinreich-domaaki-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_weinreich_domaaki.py, tests/test_source_checklists.py
...
- Counts: 135 installed records; 135 compiled citation attestations.
...
- Transcription: `conversion/weinreich-domaaki.txt`.
