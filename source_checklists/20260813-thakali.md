# Source ingestion checklist — 20260813-thakali

- Installed input: `data/other/forms/20260813-thakali.csv`
...
- Installed rows: 866
- Compiled rows carrying this unit's citation keys: 832
- Source keys: webster2021thakali

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: webster2021thakali; 866 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/thakali.py
- [x] 3. Plan the installed files and identifiers — 866 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 866}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/thakali.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_thakali.py, tests/test_source_checklists.py
...
- Counts: 866 installed records; 832 compiled citation attestations.
...
- Transcription: `conversion/thakali.txt`.
