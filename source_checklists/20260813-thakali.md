...
- Input rows with checked grammatical evidence: 9
- Compiled rows with canonical grammatical tags: 8
...
- [x] 6. Parse structured linguistic information — 9 input rows carry checked grammatical evidence; 8 compiled rows carry canonical grammatical tags
