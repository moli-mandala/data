# Source ingestion checklist — 20230524-sindhic

- Installed input: `data/other/forms/20230524-sindhic.csv`
...
- Installed rows: 203
- Compiled rows carrying this unit's citation keys: 202
- Source keys: maimani

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: maimani; 203 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/legacy_snapshots.py
- [x] 3. Plan the installed files and identifiers — 203 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 203}; blank forms 0
...
- [x] 10. Produce a complete audit trail — audit: source_checklists/audits/20230524-sindhic-snapshot-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 203 installed records; 202 compiled citation attestations.
