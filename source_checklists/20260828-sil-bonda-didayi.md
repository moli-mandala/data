# Source ingestion checklist — 20260828-sil-bonda-didayi

- Installed input: `data/other/forms/20260828-sil-bonda-didayi.csv`
...
- Installed rows: 1938
- Compiled rows carrying this unit's citation keys: 812
- Input rows with checked grammatical evidence: 0
- Compiled rows with canonical grammatical tags: 0
- Source keys: mathew-chamberlain2022bonda-didayi

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: mathew-chamberlain2022bonda-didayi; 1938 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/sil_bonda_didayi_2022/extract_pdf.py, data/other/forms/raw_data/sil_bonda_didayi_2022/import_bonda_didayi.py
- [x] 3. Plan the installed files and identifiers — 1938 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 2 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1938}; blank forms 0
- [x] 6. Parse structured linguistic information — no source-supplied grammatical labels detected by the scoped parser
- [x] 7. Build and verify the sound profile — profile route: conversion/sil-bonda-didayi.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/sil_bonda_didayi_2022/extracted_cells.tsv, data/other/forms/raw_data/20260828-sil-bonda-didayi-audit.csv, data/other/forms/raw_data/20260828-sil-bonda-didayi-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_sil_bonda_didayi_2022.py, tests/test_source_checklists.py
...
- Counts: 1938 installed records; 812 compiled citation attestations.
- Exclusions: 36 target cells at four source-disqualified prompts, seventeen explicit target no-entry/dash cells, one physically omitted target row, and all 840 Gutob, Parenga, Rona Desiya, and Oriya comparison cells are audit-only; 1,836 attested target cells yield 1,938 installed rows after comma alternatives.
- Unresolved cases: Orapadar Upper Didayi item 174 `those` at PDF page 45 / printed page 40 is physically absent and remains missing without a guessed form; no glyph is ambiguous, clipped, or illegible.
- Transcription: `conversion/sil-bonda-didayi.txt`; all 2,730 cells across thirty rendered pages were visually checked. The appendix is born-digital Unicode and OCR was not used; one broken text-map glyph was manually corrected from the rendered page.
- Validation: eight focused extraction/import/audit/profile checks pass; consolidated full build and browser QA remain deferred until the parallel survey batch lands.
- Representative app entries: Biapada body `gagəɖe`, Kaluguda body `gaːgɪɖe`, and Chitrakonda item 50 manually verified `bɷihumhaiʒã`.
