# Source ingestion checklist — 20260825-knobloch-sauji

- Installed input: `data/other/forms/20260825-knobloch-sauji.csv`
...
- [x] 1. Establish the source and scope — source keys: buddruss1967sau, knobloch2020sauji; 573 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/knobloch_sauji_2020.py
- [x] 3. Plan the installed files and identifiers — 573 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 573}; blank forms 0
- [x] 6. Parse structured linguistic information — 423 input rows carry checked grammatical evidence; 423 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/knobloch-sauji.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260825-knobloch-sauji-extract.psv, data/other/forms/raw_data/20260825-knobloch-sauji-audit.csv, data/other/forms/raw_data/20260825-knobloch-sauji-sample.csv, data/other/forms/raw_data/20260825-knobloch-sauji-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_knobloch_sauji.py, tests/test_source_checklists.py
