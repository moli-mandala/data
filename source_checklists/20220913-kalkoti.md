...
- Installed rows: 280
- Compiled rows carrying this unit's citation keys: 3602
- Input rows with checked grammatical evidence: 206
- Compiled rows with canonical grammatical tags: 3499
- Source keys: kalkoti, liljegren

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: kalkoti, liljegren; 280 installed records
...
- [x] 5. Emit the rich import schema — row widths {'8': 4, '15': 276}; blank forms 0
- [x] 6. Parse structured linguistic information — 206 input rows carry checked grammatical evidence; 3499 compiled rows carry canonical grammatical tags
...
- Counts: 280 installed records; 3602 compiled citation attestations.
