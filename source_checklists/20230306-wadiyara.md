# Source ingestion checklist — 20230306-wadiyara

- Installed input: `data/other/forms/20230306-wadiyara.csv`
...
- Installed rows: 2632
- Compiled rows carrying this unit's citation keys: 2307
- Source keys: zubair

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: zubair; 2632 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/wadiyara.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 2632}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/wadiyara.txt; replacement characters in input forms: 0
...
- Counts: 2632 installed records; 2307 compiled citation attestations.
...
- Transcription: `conversion/wadiyara.txt`.
