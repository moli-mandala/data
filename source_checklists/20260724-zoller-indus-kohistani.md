# Source ingestion checklist — 20260724-zoller-indus-kohistani

- Installed input: `data/other/forms/20260724-zoller-indus-kohistani.csv`
...
- Installed rows: 13003
- Compiled rows carrying this unit's citation keys: 12369
- Source keys: zoller2005

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: zoller2005; 13003 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/zoller_ch6.py, data/other/forms/raw_data/zoller_dictionary.py
- [x] 3. Plan the installed files and identifiers — 0 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 5 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'10': 13003}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/zoller.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260724-zoller-ch6-audit.csv, data/other/forms/raw_data/20260725-zoller-dictionary-audit.csv, source_checklists/installed-record-audit.csv.gz
...
- Counts: 13003 installed records; 12369 compiled citation attestations.
...
- Transcription: `conversion/zoller.txt`.
