# Source ingestion checklist — 20230521-old_punjabi

- Installed input: `data/other/forms/20230521-old_punjabi.csv`
...
- Installed rows: 1034
- Compiled rows carrying this unit's citation keys: 1376
- Source keys: shackle

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: shackle; 1034 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/old_punjabi.py, data/other/forms/raw_data/punjabi.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 1034}; blank forms 0
...
- Counts: 1034 installed records; 1376 compiled citation attestations.
