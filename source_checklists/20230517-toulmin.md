# Source ingestion checklist — 20230517-toulmin

- Installed input: `data/other/forms/20230517-toulmin.csv`
...
- Installed rows: 5402
- Compiled rows carrying this unit's citation keys: 5372
- Source keys: toulmin

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: toulmin; 5402 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/toulmin.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 5402}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/toulmin.txt; replacement characters in input forms: 0
...
- Counts: 5402 installed records; 5372 compiled citation attestations.
...
- Transcription: `conversion/toulmin.txt`.
