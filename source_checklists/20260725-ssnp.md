...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-ssnp04-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_ssnp.py, tests/test_ssnp04_1992.py, tests/test_source_checklists.py
