# Source ingestion checklist — 20260725-ssnp

- Installed input: `data/other/forms/20260725-ssnp.csv`
...
- Installed rows: 12779
- Compiled rows carrying this unit's citation keys: 12767
- Source keys: decker1992, rensch-decker-hallberg1992, rensch-hallberg-oleary1992

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: decker1992, rensch-decker-hallberg1992, rensch-hallberg-oleary1992; 12779 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/ssnp.py
...
- [x] 5. Emit the rich import schema — row widths {'8': 12779}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/ssnp.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_ssnp.py, tests/test_source_checklists.py
...
- Counts: 12779 installed records; 12767 compiled citation attestations.
...
- Transcription: `conversion/ssnp.txt`.
