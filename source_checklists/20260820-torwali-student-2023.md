# Source ingestion checklist — 20260820-torwali-student-2023

- Installed input: `data/other/forms/20260820-torwali-student-2023.csv`
...
- Installed rows: 1943
- Compiled rows carrying this unit's citation keys: 1943
- Input rows with checked grammatical evidence: 1936
- Compiled rows with canonical grammatical tags: 1936
- Source keys: torwali2023student

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: torwali2023student; 1943 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/torwali_student_2023.py
- [x] 3. Plan the installed files and identifiers — 1943 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 1 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 1943}; blank forms 0
- [x] 6. Parse structured linguistic information — 1936 input rows carry checked grammatical evidence; 1936 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/torwali-student.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260820-torwali-student-2023-audit.csv, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_torwali_student_2023.py, tests/test_source_checklists.py
...
- Counts: 1943 installed records; 1943 compiled citation attestations.
...
- Transcription: `conversion/torwali-student.txt`.
