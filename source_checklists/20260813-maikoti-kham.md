# Source ingestion checklist — 20260813-maikoti-kham

- Installed input: `data/other/forms/20260813-maikoti-kham.csv`
...
- Installed rows: 1147
- Compiled rows carrying this unit's citation keys: 1090
- Source keys: leman2020maikoti

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: leman2020maikoti; 1147 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/maikoti_kham.py
- [x] 3. Plan the installed files and identifiers — 1147 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 4 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'11': 1147}; blank forms 0
- [x] 6. Parse structured linguistic information — compiled rows are covered by global tag, schema, and false-positive tests
- [x] 7. Build and verify the sound profile — profile route: conversion/maikoti-kham.txt; replacement characters in input forms: 0
...
- [x] 11. Add focused regression tests — tests: tests/test_maikoti_kham.py, tests/test_source_checklists.py
...
- Counts: 1147 installed records; 1090 compiled citation attestations.
...
- Transcription: `conversion/maikoti-kham.txt`.
