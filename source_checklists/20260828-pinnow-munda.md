# Source ingestion checklist — 20260828-pinnow-munda

- Installed input: `data/other/forms/20260828-pinnow-munda.csv`
- Canonical checklist SHA-256: `23516ba5c7caeaa5310f6a32d92b86e4b9ae5e4479e792926b61dd0689129f05`
- Source-type addenda: Dictionary or glossary, Survey wordlists or comparative tables, Website/API or external CLDF, Etymological/comparative source
- Installed rows: 4051
- Compiled rows carrying this unit's citation keys: 4051
- Input rows with checked grammatical evidence: 111
- Compiled rows with canonical grammatical tags: 111
- Source keys: pinnow1959versuch

## Retrospective gate assessment

- [x] 1. Establish the source and scope — source keys: pinnow1959versuch; 4051 installed records
- [x] 2. Choose the extraction path — importer/raw route: data/other/forms/raw_data/pinnow_munda_1959.py
- [x] 3. Plan the installed files and identifiers — 4051 unique immutable Entry_Key values
- [x] 4. Model languages and dialects before emitting forms — 14 input language/lect IDs; registry gaps: none
- [x] 5. Emit the rich import schema — row widths {'15': 4051}; blank forms 0
- [x] 6. Parse structured linguistic information — 111 input rows carry checked grammatical evidence; 111 compiled rows carry canonical grammatical tags
- [x] 7. Build and verify the sound profile — profile route: conversion/pinnow-munda.txt; replacement characters in input forms: 0
...
- [x] 10. Produce a complete audit trail — audit: data/other/forms/raw_data/20260828-pinnow-munda-audit.csv, data/other/forms/raw_data/20260828-pinnow-munda-sample.csv, data/other/forms/raw_data/20260828-pinnow-munda-manifest.json, source_checklists/installed-record-audit.csv.gz
- [x] 11. Add focused regression tests — tests: tests/test_pinnow_munda_1959.py, tests/test_source_checklists.py
...
- Counts: 4051 installed records; 4051 compiled citation attestations.
- Exclusions: one Korku record explicitly marked MISSING and one exactly repeated Sora alternant are retained audit-only; all 3,339 other source records yield 4,051 installed rows.
- Unresolved cases: 3,126 rows belong to numbered Pinnow sets not cross-referenced by Rau and remain unlinked; three V278 hill/forest alternants are ambiguous between Rau m114 and m115; one Birhor record has Pinnow's EMPTY set marker; no target is inferred in these cases.
- Transcription: `conversion/pinnow-munda.txt` identity-preserves the NFC-normalized Unicode IPA exposed by SEAlang; Form and Phonemic intentionally coincide because the site offers one explicit source-IPA layer, and no OCR is involved.
...
- Representative app entries: `/references/pinnow1959versuch`, canonical Asuri, Birhor, and Turi language pages, Sora `(ə-)ˈlʔuːd-ən` 'ear' linked through Pinnow V147 to Rau m73, and the three unlinked mixed hill/forest V278 alternants.
